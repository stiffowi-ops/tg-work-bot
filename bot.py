...
# РџРѕР»СЊР·РѕРІР°С‚РµР»Рё РёР· СЌС‚РѕРіРѕ СЃРїРёСЃРєР° РїРѕР»СѓС‡Р°СЋС‚ РґРѕСЃС‚СѓРї Рє РѕР±С‹С‡РЅС‹Рј С„СѓРЅРєС†РёСЏРј Р±РѕС‚Р°,
# РґР°Р¶Рµ РµСЃР»Рё РЅРµ СЃРѕСЃС‚РѕСЏС‚ РІ ACCESS_CHAT_ID. РђРґРјРёРЅРёСЃС‚СЂР°С‚РѕСЂСЃРєРёРµ РїСЂР°РІР° РёРј
# РїСЂРёРЅСѓРґРёС‚РµР»СЊРЅРѕ РЅРµ РІС‹РґР°СЋС‚СЃСЏ.
...
def _doc_search_tokens(query: str) -> list[str]:
    """Р Р°Р·Р±РёРІР°РµС‚ Р·Р°РїСЂРѕСЃ РЅР° СЃР»РѕРІР° Рё РєРѕСЂСЂРµРєС‚РЅРѕ РїСЂРёРІРѕРґРёС‚ РєРёСЂРёР»Р»РёС†Сѓ Рє РЅРёР¶РЅРµРјСѓ СЂРµРіРёСЃС‚СЂСѓ."""
    return [
...
def db_docs_search(query: str, limit: int = 40) -> list[dict]:
    """
    РС‰РµС‚ РїРѕ РЅР°Р·РІР°РЅРёСЋ, РѕРїРёСЃР°РЅРёСЋ, РєР°С‚РµРіРѕСЂРёРё Рё СЃРІСЏР·Р°РЅРЅС‹Рј С‚РµРіР°Рј.

    SQLite ``NOCASE`` СЂР°Р±РѕС‚Р°РµС‚ С‚РѕР»СЊРєРѕ РґР»СЏ ASCII, РїРѕСЌС‚РѕРјСѓ СЃСЂР°РІРЅРµРЅРёРµ РІС‹РїРѕР»РЅСЏРµС‚СЃСЏ
    РІ Python С‡РµСЂРµР· ``casefold``. Р’СЃРµ СЃР»РѕРІР° Р·Р°РїСЂРѕСЃР° РѕР±СЏР·Р°С‚РµР»СЊРЅС‹, С‡С‚Рѕ РїРѕР·РІРѕР»СЏРµС‚
    РёСЃРєР°С‚СЊ, РЅР°РїСЂРёРјРµСЂ, ``РѕС‚РїСѓСЃРє hr`` РЅРµР·Р°РІРёСЃРёРјРѕ РѕС‚ РїРѕСЂСЏРґРєР° СЃР»РѕРІ РІ РєР°СЂС‚РѕС‡РєРµ.
    """
...
def db_docs_search_by_tag(tag_id: int, limit: int = 40) -> list[dict]:
    """Р’РѕР·РІСЂР°С‰Р°РµС‚ РґРѕРєСѓРјРµРЅС‚С‹, Сѓ РєРѕС‚РѕСЂС‹С… РІС‹Р±СЂР°РЅРЅС‹Р№ С‚РµРі РЅР°Р·РЅР°С‡РµРЅ СЏРІРЅРѕ."""
    con = sqlite3.connect(DB_PATH)
    cur = con.cursor()
    cur.execute(
        """
...
def db_notifications_list(user_id: int, page: int = 0, page_size: int = 8) -> dict:
    """
    Р’РѕР·РІСЂР°С‰Р°РµС‚ С‚РѕР»СЊРєРѕ РЅРµРїСЂРѕС‡РёС‚Р°РЅРЅС‹Рµ СѓРІРµРґРѕРјР»РµРЅРёСЏ.

    РџСЂРѕС‡РёС‚Р°РЅРЅС‹Рµ Р·Р°РїРёСЃРё РѕСЃС‚Р°СЋС‚СЃСЏ РІ Р‘Р” РєР°Рє С‚РµС…РЅРёС‡РµСЃРєР°СЏ РёСЃС‚РѕСЂРёСЏ РґРѕСЃС‚Р°РІРєРё, С‡С‚РѕР±С‹
    РѕРґРЅРѕСЂР°Р·РѕРІС‹Рµ РЅР°РїРѕРјРёРЅР°РЅРёСЏ РЅРµ СЃРѕР·РґР°РІР°Р»РёСЃСЊ РїРѕРІС‚РѕСЂРЅРѕ, РЅРѕ РІ РїРѕР»СЊР·РѕРІР°С‚РµР»СЊСЃРєРѕРј
    СЂР°Р·РґРµР»Рµ В«РЈРІРµРґРѕРјР»РµРЅРёСЏВ» РѕРЅРё Р±РѕР»СЊС€Рµ РЅРµ РѕС‚РѕР±СЂР°Р¶Р°СЋС‚СЃСЏ.
    """
    con = sqlite3.connect(DB_PATH)
    cur = con.cursor()
    cur.execute(
...
async def is_member_of_access_chat(user_id: int, context: ContextTypes.DEFAULT_TYPE) -> bool:
    """
    True, РµСЃР»Рё РїРѕР»СЊР·РѕРІР°С‚РµР»СЊ СЃРѕСЃС‚РѕРёС‚ РІ ACCESS_CHAT_ID РёР»Рё РїРѕР»СѓС‡РёР» РѕС‚РґРµР»СЊРЅС‹Р№
    РїРѕР»СЊР·РѕРІР°С‚РµР»СЊСЃРєРёР№ РґРѕРїСѓСЃРє Р±РµР· РїСЂР°РІ Р°РґРјРёРЅРёСЃС‚СЂР°С‚РѕСЂР°.
    """
    if int(user_id) in NON_ADMIN_ACCESS_USER_IDS:
        return True
    try:
...
def get_scope_chat_id(update: Update, context: ContextTypes.DEFAULT_TYPE) -> int | None:
    ...
    try:
        return int(scope_chat_id) if scope_chat_id is not None else None
    except (TypeError, ValueError):
        return None
...
def kb_notifications(user_id: int, page: int = 0):
    ...
    if db_notifications_unread_count(int(user_id)):
        rows.append([InlineKeyboardButton("рџ§№ РџСЂРѕС‡РёС‚Р°С‚СЊ Рё РѕС‡РёСЃС‚РёС‚СЊ РІСЃРµ", callback_data="help:notifications:read_all")])
...
DOCS_RECOMMENDATION_TEXT = (
    "рџ”Ћ Р РµРєРѕРјРµРЅРґР°С†РёСЏ\n\n"
    "Р РµРєРѕРјРµРЅРґСѓСЋ РІРѕСЃРїРѕР»СЊР·РѕРІР°С‚СЊСЃСЏ РїРѕРёСЃРєРѕРј вЂ” РѕРЅ РїРѕРјРѕР¶РµС‚ Р±С‹СЃС‚СЂРµРµ РЅР°Р№С‚Рё РЅСѓР¶РЅС‹Р№ "
    "РґРѕРєСѓРјРµРЅС‚ РІ СЃРїРёСЃРєРµ РїРѕ СЃРІСЏР·Р°РЅРЅС‹Рј С‚РµРіР°Рј."
)
...
def kb_help_docs_main(is_admin_user: bool):
    rows = [
        ...
        [InlineKeyboardButton("рџ“‚ Р’СЃРµ РґРѕРєСѓРјРµРЅС‚С‹", callback_data="help:docs:categories")],
...
def kb_docs_search_tags():
    """РљРЅРѕРїРєРё РґРѕСЃС‚СѓРїРЅС‹С… С‚РµРіРѕРІ РґР»СЏ Р±С‹СЃС‚СЂРѕРіРѕ РїРѕРёСЃРєР° РґРѕРєСѓРјРµРЅС‚РѕРІ."""
...
def kb_doc_card(doc_id: int, user_id: int | None, back_cb: str = "help:docs"):
    ...
    return InlineKeyboardMarkup([
        ...
        [
            InlineKeyboardButton(
                "рџ¤ќ РџРѕРґРµР»РёС‚СЊСЃСЏ СЃ РєРѕР»Р»РµРіРѕР№",
...
async def inline_query_documents(
    ...
    """
    РћС‚РґР°С‘С‚ РґРѕРєСѓРјРµРЅС‚ РІ inline-СЂРµР¶РёРјРµ Telegram.

    РџРѕР»СЊР·РѕРІР°С‚РµР»СЊ СЃР°Рј РІС‹Р±РёСЂР°РµС‚ С‡Р°С‚ Рё РѕС‚РїСЂР°РІР»СЏРµС‚ СЂРµР·СѓР»СЊС‚Р°С‚, РїРѕСЌС‚РѕРјСѓ РІ
    РїРµСЂРµРїРёСЃРєРµ РѕС‚РїСЂР°РІРёС‚РµР»РµРј Р±СѓРґРµС‚ РµРіРѕ Р°РєРєР°СѓРЅС‚ (Telegram РјРѕР¶РµС‚ РґРѕР±Р°РІРёС‚СЊ
    РїРѕРјРµС‚РєСѓ ``via @bot``). Р‘РѕС‚ Р»РёС€СЊ РїСЂРµРґРѕСЃС‚Р°РІР»СЏРµС‚ cached document result.
    """
    ...
    result = InlineQueryResultCachedDocument(
        ...
        title=str(doc.get("title") or "Р”РѕРєСѓРјРµРЅС‚")[:128],
...
# Р”Р»СЏ РєР°Р¶РґРѕРіРѕ РЅР°Р·РЅР°С‡РµРЅРёСЏ СЃРѕС‚СЂСѓРґРЅРёРєСѓ РґРѕСЃС‚СѓРїРЅР° СЂРѕРІРЅРѕ РѕРґРЅР° РїРѕРїС‹С‚РєР°. РџРѕРІС‚РѕСЂРЅРѕРµ
# РїСЂРѕС…РѕР¶РґРµРЅРёРµ РїРѕСЏРІР»СЏРµС‚СЃСЏ С‚РѕР»СЊРєРѕ РїРѕСЃР»Рµ РЅРѕРІРѕРіРѕ РЅР°Р·РЅР°С‡РµРЅРёСЏ Р°РґРјРёРЅРёСЃС‚СЂР°С‚РѕСЂРѕРј.
TEST_MAX_ATTEMPTS = 1
TEST_RETAKE_POLICY_TEXT = (
    "Р”РѕСЃС‚СѓРїРЅР° С‚РѕР»СЊРєРѕ РѕРґРЅР° РїРѕРїС‹С‚РєР°. РџРѕСЃР»Рµ Р·Р°РІРµСЂС€РµРЅРёСЏ С‚РµСЃС‚ РЅРµР»СЊР·СЏ РїСЂРѕР№С‚Рё РїРѕРІС‚РѕСЂРЅРѕ; "
    "РЅРѕРІР°СЏ РїРѕРїС‹С‚РєР° РїРѕСЏРІРёС‚СЃСЏ С‚РѕР»СЊРєРѕ РїРѕСЃР»Рµ РїРѕРІС‚РѕСЂРЅРѕРіРѕ РЅР°Р·РЅР°С‡РµРЅРёСЏ Р°РґРјРёРЅРёСЃС‚СЂР°С‚РѕСЂРѕРј."
)
...
async def cb_test(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if action == "start" and len(parts) >= 3:
        ...
        # РЎС‚Р°СЂС‹Рµ СѓРІРµРґРѕРјР»РµРЅРёСЏ РјРѕРіР»Рё СЃРѕРґРµСЂР¶Р°С‚СЊ РїСЂСЏРјСѓСЋ СЃСЃС‹Р»РєСѓ `test:start`.
        # РћРЅР° РЅРµ РґРѕР»Р¶РЅР° РІРѕР·РІСЂР°С‰Р°С‚СЊ СЃРѕС‚СЂСѓРґРЅРёРєР° РІ СѓР¶Рµ Р·Р°РІРµСЂС€С‘РЅРЅРѕРµ РЅР°Р·РЅР°С‡РµРЅРёРµ.
        if a.get("status") not in ("assigned", "in_progress"):
            await q.answer(
                "Р­С‚РѕС‚ С‚РµСЃС‚ СѓР¶Рµ Р·Р°РІРµСЂС€С‘РЅ РёР»Рё РЅРµРґРѕСЃС‚СѓРїРµРЅ. РќРѕРІР°СЏ РїРѕРїС‹С‚РєР° РІРѕР·РјРѕР¶РЅР° "
                "С‚РѕР»СЊРєРѕ РїРѕСЃР»Рµ РїРѕРІС‚РѕСЂРЅРѕРіРѕ РЅР°Р·РЅР°С‡РµРЅРёСЏ Р°РґРјРёРЅРёСЃС‚СЂР°С‚РѕСЂРѕРј.",
                show_alert=True,
            )
            return
        ...
        if not db_test_update_assignment_start(aid, deadline_iso):
            await q.answer(
                "Р­С‚РѕС‚ С‚РµСЃС‚ СѓР¶Рµ Р·Р°РІРµСЂС€С‘РЅ РёР»Рё РЅРµРґРѕСЃС‚СѓРїРµРЅ.",
                show_alert=True,
            )
            return
...
async def cb_help(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if data == "help:notifications" or data.startswith("help:notifications:page:"):
        ...
        await q.edit_message_text(
            ...
            "РџРѕСЃР»Рµ РїСЂРѕС‡С‚РµРЅРёСЏ СѓРІРµРґРѕРјР»РµРЅРёРµ Р°РІС‚РѕРјР°С‚РёС‡РµСЃРєРё РёСЃС‡РµР·РЅРµС‚ РёР· СЂР°Р·РґРµР»Р°.",
            parse_mode=ParseMode.HTML,
    ...
    if data.startswith("help:notifications:open:"):
        ...
        # РЎС‚Р°СЂС‹Рµ Р·Р°РїРёСЃРё С†РµРЅС‚СЂР° СѓРІРµРґРѕРјР»РµРЅРёР№ РІРµР»Рё РЅР°РїСЂСЏРјСѓСЋ РІ `test:start`.
        # РџРµСЂРµРЅР°РїСЂР°РІР»СЏРµРј РёС… РЅР° РёРЅС„РѕСЂРјР°С†РёРѕРЅРЅСѓСЋ РєР°СЂС‚РѕС‡РєСѓ РЅР°Р·РЅР°С‡РµРЅРёСЏ: РєР°СЂС‚РѕС‡РєР°
        # СЃР°РјР° РїРѕРєР°Р¶РµС‚ РєРЅРѕРїРєСѓ С‚РѕР»СЊРєРѕ РґР»СЏ СЂРµР°Р»СЊРЅРѕ РЅР°Р·РЅР°С‡РµРЅРЅРѕРіРѕ/РЅРµР·Р°РІРµСЂС€С‘РЅРЅРѕРіРѕ
        # С‚РµСЃС‚Р° Рё РЅРёРєРѕРіРґР° РЅРµ Р·Р°РїСѓСЃРєР°РµС‚ РїРѕРІС‚РѕСЂРЅРѕРµ РїСЂРѕС…РѕР¶РґРµРЅРёРµ.
    ...
    if data == "help:notifications:read_all":
        ...
        await q.answer(f"РџСЂРѕС‡РёС‚Р°РЅРѕ Рё СѓР±СЂР°РЅРѕ: {count}")
        await q.edit_message_text(
            "рџ”” <b>РЈРІРµРґРѕРјР»РµРЅРёСЏ</b>\n\nР Р°Р·РґРµР» РѕС‡РёС‰РµРЅ вЂ” РЅРµРїСЂРѕС‡РёС‚Р°РЅРЅС‹С… СѓРІРµРґРѕРјР»РµРЅРёР№ РЅРµС‚.",
            parse_mode=ParseMode.HTML,
    ...
    if data.startswith("help:suggest:mode:"):
        ...
        if mode not in {"anon", "named"}:
            try:
                await q.answer("РќРµРёР·РІРµСЃС‚РЅС‹Р№ СЂРµР¶РёРј РїСЂРµРґР»РѕР¶РєРё.", show_alert=True)
            except (TimedOut, NetworkError):
                pass
            return
        # Р’ Р›РЎ Сѓ РїРѕР»СЊР·РѕРІР°С‚РµР»СЏ РјРѕР¶РµС‚ РµС‰С‘ РЅРµ Р±С‹С‚СЊ СЃРѕС…СЂР°РЅС‘РЅРЅРѕР№ РїСЂРёРІСЏР·РєРё Рє С‡Р°С‚Сѓ
        # (РЅР°РїСЂРёРјРµСЂ, РµСЃР»Рё РѕРЅ РІРїРµСЂРІС‹Рµ РѕС‚РєСЂС‹Р» /help РёРјРµРЅРЅРѕ С‚Р°Рј). Р’ С‚Р°РєРѕРј СЃР»СѓС‡Р°Рµ
        # РёСЃРїРѕР»СЊР·СѓРµРј РѕСЃРЅРѕРІРЅРѕР№ СЂР°Р±РѕС‡РёР№ С‡Р°С‚, РЅРѕ РЅРµ Р·Р°С‚РёСЂР°РµРј СЂР°РЅРµРµ РІС‹Р±СЂР°РЅРЅСѓСЋ
        # РіСЂСѓРїРїРѕРІСѓСЋ РїСЂРёРІСЏР·РєСѓ.
        scope_chat_id = get_scope_chat_id(update, context) or ACCESS_CHAT_ID
    ...
    if data.startswith("help:docs:search:tag:"):
        ...
        context.user_data[DOCS_RETURN_CB] = "help:docs"
        await q.edit_message_text(
            f"рџЏ· <b>#{escape(tag['title'])}</b>\n\n"
            f"РќР°Р№РґРµРЅРѕ РґРѕРєСѓРјРµРЅС‚РѕРІ: <b>{len(items)}</b>",
            parse_mode=ParseMode.HTML,
            reply_markup=kb_docs_result_list(items, "вЂ” РґРѕРєСѓРјРµРЅС‚РѕРІ СЃ СЌС‚РёРј С‚РµРіРѕРј РЅРµС‚ вЂ”"),
        )
        return
    ...
    if data == "help:docs:search":
        ...
        await q.edit_message_text(
            ...
            "РџРѕРёСЃРє СѓС‡РёС‚С‹РІР°РµС‚ СЃРІСЏР·Р°РЅРЅС‹Рµ С‚РµРіРё Рё РЅРµСЃРєРѕР»СЊРєРѕ СЃР»РѕРІ РІ Р»СЋР±РѕРј РїРѕСЂСЏРґРєРµ.\n\n"
            "РР»Рё РІС‹Р±РµСЂРёС‚Рµ С‚РµРі:",
            parse_mode=ParseMode.HTML,
    ...
    if data.startswith("help:docs:share:"):
        ...
        try:
            ...
            await q.answer("РќРµРєРѕСЂСЂРµРєС‚РЅС‹Р№ РґРѕРєСѓРјРµРЅС‚.", show_alert=True)
            return
        doc = db_docs_get(doc_id)
        if not doc:
            ...
            return
        await q.edit_message_text(
            f"рџ¤ќ <b>РџРѕРґРµР»РёС‚СЊСЃСЏ РґРѕРєСѓРјРµРЅС‚РѕРј</b>\n\n"
            f"Р”РѕРєСѓРјРµРЅС‚: <b>{escape(doc['title'])}</b>\n\n"
            "РќР°Р¶РјРёС‚Рµ РєРЅРѕРїРєСѓ РЅРёР¶Рµ, РІС‹Р±РµСЂРёС‚Рµ С‡Р°С‚ Рё РѕС‚РїСЂР°РІСЊС‚Рµ С„Р°Р№Р». "
            "РЎРѕРѕР±С‰РµРЅРёРµ Р±СѓРґРµС‚ РѕС‚РїСЂР°РІР»РµРЅРѕ РѕС‚ РІР°С€РµРіРѕ Р°РєРєР°СѓРЅС‚Р°, Р° РЅРµ РѕС‚ Р±РѕС‚Р°:",
            parse_mode=ParseMode.HTML,
            reply_markup=InlineKeyboardMarkup([
                [
                    InlineKeyboardButton(
                        "рџ¤ќ Р’С‹Р±СЂР°С‚СЊ С‡Р°С‚ РІ Telegram",
                        switch_inline_query=f"doc:{int(doc_id)}",
                    )
                ],
                [
                    InlineKeyboardButton(
                        "в¬…пёЏ Рљ РґРѕРєСѓРјРµРЅС‚Сѓ",
    ...
    if data.startswith("help:docs:share_to:"):
        await q.answer(
            "РСЃРїРѕР»СЊР·СѓР№С‚Рµ РєРЅРѕРїРєСѓ В«Р’С‹Р±СЂР°С‚СЊ С‡Р°С‚ РІ TelegramВ», "
            "С‡С‚РѕР±С‹ РѕС‚РїСЂР°РІРёС‚СЊ РґРѕРєСѓРјРµРЅС‚ РѕС‚ СЃРІРѕРµРіРѕ Р°РєРєР°СѓРЅС‚Р°.",
            show_alert=True,
        )
        return
                ...
                if tg_user_id:
                    try:
                        ...
                        await context.bot.send_message(
                            chat_id=tg_user_id,
                            text=notify_text,
                            reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton("в–¶пёЏ РћС‚РєСЂС‹С‚СЊ РЅР°Р·РЅР°С‡РµРЅРёРµ", callback_data=assignment_callback)]]),
                            disable_web_page_preview=True,
                        )
                        db_notification_add(
                            tg_user_id,
                            ...
                            f"Р”Р»РёС‚РµР»СЊРЅРѕСЃС‚СЊ: {duration_text}. {TEST_RETAKE_POLICY_TEXT}",
...
async def on_text(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if context.user_data.get(WAITING_SUGGESTION_TEXT):
        ...
        try:
            sent_ok, sent_fail = await send_suggestion_to_admins(
                scope_chat_id, update, context, text, mode
            )
        except Exception:
            logger.exception("Unexpected error while sending suggestion")
            sent_ok, sent_fail = 0, 0
        clear_suggest_flow(context)

        if sent_ok <= 0:
            await update.message.reply_text(
                "вљ пёЏ РќРµ СѓРґР°Р»РѕСЃСЊ РїРµСЂРµРґР°С‚СЊ СЃРѕРѕР±С‰РµРЅРёРµ С‚РёРјР»РёРґСѓ. "
                "РџРѕРїСЂРѕР±СѓР№С‚Рµ РµС‰С‘ СЂР°Р· С‡СѓС‚СЊ РїРѕР·Р¶Рµ."
            )
            return

        # РћРіСЂР°РЅРёС‡РёРІР°РµРј РїРѕРІС‚РѕСЂРЅСѓСЋ РѕС‚РїСЂР°РІРєСѓ С‚РѕР»СЊРєРѕ РїРѕСЃР»Рµ СѓСЃРїРµС€РЅРѕР№ РґРѕСЃС‚Р°РІРєРё С…РѕС‚СЏ
        # Р±С‹ РѕРґРЅРѕРјСѓ Р°РґРјРёРЅРёСЃС‚СЂР°С‚РѕСЂСѓ. Р Р°РЅСЊС€Рµ Р»РёРјРёС‚ РІС‹СЃС‚Р°РІР»СЏР»СЃСЏ РґР°Р¶Рµ РїСЂРё РїРѕР»РЅРѕРј
        # РїСЂРѕРІР°Р»Рµ РѕС‚РїСЂР°РІРєРё, РёР·-Р·Р° С‡РµРіРѕ В«РџСЂРµРґР»РѕР¶РєР°В» РєР°Р·Р°Р»Р°СЃСЊ СЃР»РѕРјР°РЅРЅРѕР№.
        if user_id:
            db_set_suggest_last_ts(user_id, int(time.time()))

        if sent_fail:
            await update.message.reply_text(
                f"вњ… РџРµСЂРµРґР°Р» С‚РёРјР»РёРґСѓ ({sent_ok}). "
                "Р§Р°СЃС‚СЊ Р°РґРјРёРЅРёСЃС‚СЂР°С‚РѕСЂРѕРІ СЃРµР№С‡Р°СЃ РЅРµРґРѕСЃС‚СѓРїРЅР°."
            )
        else:
...
async def send_suggestion_to_admins(scope_chat_id: int, update: Update, context: ContextTypes.DEFAULT_TYPE, message_text: str, mode: str) -> tuple[int, int]:
    ...
    # РЎРѕРѕР±С‰РµРЅРёРµ Р°РґРјРёРЅРёСЃС‚СЂР°С‚РѕСЂСѓ РѕС‚РїСЂР°РІР»СЏРµС‚СЃСЏ РІ HTML-СЂРµР¶РёРјРµ. Р­РєСЂР°РЅРёСЂСѓРµРј РІСЃРµ
    # РґРёРЅР°РјРёС‡РµСЃРєРёРµ РїРѕР»СЏ, РёРЅР°С‡Рµ СЃРёРјРІРѕР»С‹ РІСЂРѕРґРµ "&" РёР»Рё "<" Р»РѕРјР°СЋС‚ Р·Р°РїСЂРѕСЃ
    # Telegram Рё РІСЃСЏ С„СѓРЅРєС†РёСЏ В«РџСЂРµРґР»РѕР¶РєР°В» РІС‹РіР»СЏРґРёС‚ РЅРµСЂР°Р±РѕС‚Р°СЋС‰РµР№.
    chat_title_html = html_lib.escape(str(chat_title), quote=False)
    raw_text = (message_text or "").strip()
    if not raw_text:
        return (0, 0)

    # Telegram РѕРіСЂР°РЅРёС‡РёРІР°РµС‚ РґР»РёРЅСѓ СЃРѕРѕР±С‰РµРЅРёСЏ 4096 СЃРёРјРІРѕР»Р°РјРё. РћСЃС‚Р°РІР»СЏРµРј Р·Р°РїР°СЃ
    # РїРѕРґ Р·Р°РіРѕР»РѕРІРѕРє Рё Р±РµР·РѕРїР°СЃРЅРѕ РѕР±СЂРµР·Р°РµРј РёСЃС…РѕРґРЅС‹Р№ С‚РµРєСЃС‚ РґРѕ С„РѕСЂРјРёСЂРѕРІР°РЅРёСЏ HTML.
    if len(raw_text) > 3200:
        raw_text = raw_text[:3200].rstrip() + "\nвЂ¦"
        message_html = html_lib.escape(raw_text, quote=False)
    else:
        message_html = message_to_html(getattr(update, "message", None))
        if not message_html:
            message_html = html_lib.escape(raw_text, quote=False)

    if mode == "anon":
        sender_line = "РћС‚: <b>РђРЅРѕРЅРёРјРЅРѕ</b>"
    else:
        user_name_html = html_lib.escape(str(user_name), quote=False)
        username_html = html_lib.escape(username, quote=False)
        sender_line = (
            f"РћС‚: <b>{user_name_html}</b> {username_html} "
            f"(<code>{int(user_id)}</code>)"
        )

    admin_text = (
        f"рџ’Ў <b>РџСЂРµРґР»РѕР¶РєР°</b> ({mode_label})\n"
        f"Р§Р°С‚: <b>{chat_title_html}</b> (<code>{int(scope_chat_id)}</code>)\n"
        f"{sender_line}\n\n"
...
def tv2_create_assignment(template_id: int, profile_id: int, assigned_by: int | None,
    ...
    # Р РµС‚СЂР°Р№ РЅРµ СЃРѕР·РґР°С‘С‚СЃСЏ РёР· РїРѕР»СЊР·РѕРІР°С‚РµР»СЊСЃРєРѕРіРѕ РїРѕС‚РѕРєР°. РќРѕРІС‹Р№ assignment
    # РІСЃРµРіРґР° СЏРІР»СЏРµС‚СЃСЏ РѕС‚РґРµР»СЊРЅС‹Рј Р°РґРјРёРЅРёСЃС‚СЂР°С‚РѕСЂСЃРєРёРј РЅР°Р·РЅР°С‡РµРЅРёРµРј СЃ РѕРґРЅРѕР№ РїРѕРїС‹С‚РєРѕР№.
...
def tv2_can_retry(a: dict) -> bool:
    # РџРѕРІС‚РѕСЂРЅРѕРµ РїСЂРѕС…РѕР¶РґРµРЅРёРµ РІРѕР·РјРѕР¶РЅРѕ С‚РѕР»СЊРєРѕ С‡РµСЂРµР· РЅРѕРІРѕРµ РЅР°Р·РЅР°С‡РµРЅРёРµ Р°РґРјРёРЅРёСЃС‚СЂР°С‚РѕСЂРѕРј.
    return False


def tv2_create_retry(aid: int, user_id: int | None) -> int | None:
    # РћСЃС‚Р°РІР»СЏРµРј С„СѓРЅРєС†РёСЋ РґР»СЏ СЃРѕРІРјРµСЃС‚РёРјРѕСЃС‚Рё СЃРѕ СЃС‚Р°СЂС‹РјРё callback_data, РЅРѕ РЅРёРєРѕРіРґР°
    # РЅРµ СЃРѕР·РґР°С‘Рј РїРѕР»СЊР·РѕРІР°С‚РµР»СЊСЃРєРёР№ retry.
    return None
...
def tv2_result_text(aid: int) -> str:
    ...
    lines.append(f"РџРѕРїС‹С‚РєР°: <b>{TEST_MAX_ATTEMPTS} РёР· {TEST_MAX_ATTEMPTS}</b>")
...
def tv2_template_text(tid: int) -> str:
    ...
    return (
        ...
        f"РџРѕРїС‹С‚РѕРє: <b>{TEST_MAX_ATTEMPTS}</b>\n"
...
def tv2_my_open_text(a: dict) -> str:
    ...
    text=(f"рџ“ќ <b>{escape(a['title'])}</b>\n\n"
          ...
          f"РџРѕРїС‹С‚РєР°: <b>{TEST_MAX_ATTEMPTS} РёР· {TEST_MAX_ATTEMPTS}</b>\n"
          f"в„№пёЏ {escape(TEST_RETAKE_POLICY_TEXT)}")
...
async def cb_help(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if data.startswith("help:testv2:setvalue:"):
        ...
        # Р”Р°Р¶Рµ СЃС‚Р°СЂС‹Рµ РєРЅРѕРїРєРё/СЃСЃС‹Р»РєРё СЃ values 2, 3 РёР»Рё 99 РЅРµ РјРѕРіСѓС‚ РІРєР»СЋС‡РёС‚СЊ
        # РїРѕРІС‚РѕСЂРЅРѕРµ РїСЂРѕС…РѕР¶РґРµРЅРёРµ.
...
async def cb_test(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if action in ("start","continue"):
        ...
        if not tv2_start_assignment(aid):
            await q.answer("Р­С‚РѕС‚ С‚РµСЃС‚ СѓР¶Рµ Р·Р°РІРµСЂС€С‘РЅ РёР»Рё РЅРµРґРѕСЃС‚СѓРїРµРЅ.", show_alert=True)
            return
        tv2_clear(context); await tv2_send_question(update,context,aid); return

    if action=="retry":
        await q.answer(
            "РџРѕРІС‚РѕСЂРЅРѕРµ РїСЂРѕС…РѕР¶РґРµРЅРёРµ РЅРµРґРѕСЃС‚СѓРїРЅРѕ. РќРѕРІР°СЏ РїРѕРїС‹С‚РєР° РїРѕСЏРІРёС‚СЃСЏ С‚РѕР»СЊРєРѕ "
            "РїРѕСЃР»Рµ РїРѕРІС‚РѕСЂРЅРѕРіРѕ РЅР°Р·РЅР°С‡РµРЅРёСЏ Р°РґРјРёРЅРёСЃС‚СЂР°С‚РѕСЂРѕРј.",
            show_alert=True,
        )
        return
...
async def on_text(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if state.startswith("custom_"):
        ...
        if setting == "attempts":
            tv2_clear(context)
            await update.message.reply_text(
                "вњ… Р”Р»СЏ РІСЃРµС… С‚РµСЃС‚РѕРІ РґРѕСЃС‚СѓРїРЅР° С‚РѕР»СЊРєРѕ РѕРґРЅР° РїРѕРїС‹С‚РєР°.",
                reply_markup=InlineKeyboardMarkup([
                    [InlineKeyboardButton("РќР°СЃС‚СЂРѕР№РєРё", callback_data=f"help:testv2:settings:{tid}")]
                ]),
            )
            return
...
def kb_help_main(is_admin_user: bool, unread_count: int = 0):
    ...
    # РЎС‚Р°РІРёРј РґР»РёРЅРЅС‹Рµ РєРЅРѕРїРєРё В«РљРµР№СЃС‹В» Рё В«РќР°РїРѕРјРёРЅР°Р»РєР°В» РЅРµРїРѕСЃСЂРµРґСЃС‚РІРµРЅРЅРѕ РїРµСЂРµРґ
    ...
    # Сѓ РєРѕС‚РѕСЂРѕРіРѕ С‚Р°РєРѕР№ РєРЅРѕРїРєРё РЅРµС‚, РѕРЅРё Р±СѓРґСѓС‚ РїРѕСЃР»РµРґРЅРёРјРё СЃС‚СЂРѕРєР°РјРё РјРµРЅСЋ.
...
async def tv3_notify_result_ready(context, aid: int):
    ...
    if not assignment or not assignment.get("tg_user_id"):
        return
    calc = tv3_calculation(aid)
    result_status = "С‚РµСЃС‚ РїСЂРѕР№РґРµРЅ" if calc.get("passed") else "С‚РµСЃС‚ РЅРµ РїСЂРѕР№РґРµРЅ"
    db_notification_add_once(
        int(assignment["tg_user_id"]),
        "test_result_ready",
        f"Р РµР·СѓР»СЊС‚Р°С‚ С‚РµСЃС‚Р° РіРѕС‚РѕРІ: {assignment['title']}",
        (
            f"Р РµР·СѓР»СЊС‚Р°С‚: {calc.get('percent', 0):.0f}%. РЎС‚Р°С‚СѓСЃ: {result_status}. "
            f"{TEST_RETAKE_POLICY_TEXT}"
        ),
...
def db_init():
    ...
    # Р•РґРёРЅР°СЏ РїРѕР»РёС‚РёРєР°: Сѓ РєР°Р¶РґРѕРіРѕ С‚РµСЃС‚Р° СЂРѕРІРЅРѕ РѕРґРЅР° РїРѕРїС‹С‚РєР°. Р­С‚Рѕ С‚Р°РєР¶Рµ
    # РЅРѕСЂРјР°Р»РёР·СѓРµС‚ СЃС‚Р°СЂС‹Рµ С€Р°Р±Р»РѕРЅС‹, РіРґРµ СЂР°РЅСЊС€Рµ Р±С‹Р»Рё РґРѕСЃС‚СѓРїРЅС‹ 2/3/99 РїРѕРїС‹С‚РѕРє,
    # Рё СЃС‚Р°СЂС‹Рµ РЅР°Р·РЅР°С‡РµРЅРёСЏ, СЃРѕР·РґР°РЅРЅС‹Рµ С‡РµСЂРµР· РїСЂРµР¶РЅРёР№ retry-РїРѕС‚РѕРє.
    cur.execute(
...
# ===================== CASES CATALOG =====================
# РЎРЅРёРјРѕРє РїСѓР±Р»РёС‡РЅС‹С… РєР°СЂС‚РѕС‡РµРє СЃРѕ СЃС‚СЂР°РЅРёС†С‹ https://yandex.ru/routing/cases.
# Р”Р»РёРЅРЅС‹Рµ СЃС‚Р°С‚СЊРё РѕС‚РєСЂС‹РІР°СЋС‚СЃСЏ РѕС‚РґРµР»СЊРЅРѕР№ URL-РєРЅРѕРїРєРѕР№; РґР»СЏ РєР°СЂС‚РѕС‡РµРє Р±РµР·
# РѕС‚РґРµР»СЊРЅРѕР№ СЃС‚Р°С‚СЊРё РёСЃРїРѕР»СЊР·СѓРµС‚СЃСЏ РѕР±С‰РёР№ СЂР°Р·РґРµР» РєРµР№СЃРѕРІ.
...
CASES_CATEGORY_DEFS = [
    ("all", "Р’СЃРµ РєРµР№СЃС‹"),
    ("home", "Р”РѕРј, СЂРµРјРѕРЅС‚, СЃР°Рґ"),
    ("auto", "РђРІС‚РѕС‚РѕРІР°СЂС‹"),
    ("alcohol", "РђР»РєРѕРіРѕР»СЊ Рё С‚Р°Р±Р°Рє"),
    ("production", "РџСЂРѕРёР·РІРѕРґСЃС‚РІРѕ Рё РїСЂРѕРјС‹С€Р»РµРЅРЅРѕСЃС‚СЊ"),
    ("fmcg", "FMCG"),
    ("logistics", "Р›РѕРіРёСЃС‚РёРєР°"),
    ("bakery", "РҐР»РµР±РѕР±СѓР»РѕС‡РЅС‹Рµ РёР·РґРµР»РёСЏ"),
    ("ecom", "E-com"),
    ("medicine", "РњРµРґРёС†РёРЅР° Рё С„Р°СЂРјР°С†РµРІС‚РёРєР°"),
    ("services", "РЎРµСЂРІРёСЃРЅС‹Рµ СѓСЃР»СѓРіРё"),
    ("finance", "Р‘Р°РЅРєРё Рё С„РёРЅР°РЅСЃС‹"),
    ("retail", "Р РёС‚РµР№Р»"),
]
...
def _cases_category_options() -> list[tuple[str, str]]:
    """Р’РѕР·РІСЂР°С‰Р°РµС‚ РѕС‚СЂР°СЃР»Рё РІ РїРѕСЂСЏРґРєРµ СѓР±С‹РІР°РЅРёСЏ РґР»РёРЅС‹ РЅР°Р·РІР°РЅРёСЏ."""
    return sorted(
        (
            (key, label)
...
CASES_DATA = [
    _case(
        "maria", "РњР°СЂРёСЏ", ("Р”РѕРј, СЂРµРјРѕРЅС‚, СЃР°Рґ"),
        "в€’35% Р·Р°С‚СЂР°С‚ РЅР° РїРѕСЃР»РµРґРЅСЋСЋ РјРёР»СЋ",
        "РЈС‚РёР»РёР·РёСЂРѕРІР°Р»Рё СЃРІРѕР№ Р°РІС‚РѕРїР°СЂРє Рё СѓС€Р»Рё РѕС‚ РЅР°С‘РјРЅРѕРіРѕ; РґРѕР»СЏ РЅР°С‘РјРЅС‹С… РјР°С€РёРЅ РґРѕС…РѕРґРёР»Р° РґРѕ 40% РІСЃРµС… РўРЎ.",
        "https://yandex.ru/routing/articles/kukhni-mariya/",
    ),
    _case(
        "rossko", "Р РѕСЃСЃРєРѕ", ("РђРІС‚РѕС‚РѕРІР°СЂС‹"),
        "25% СЃРѕРєСЂР°С‰РµРЅРёРµ Р·Р°С‚СЂР°С‚ РЅР° Р»РѕРіРёСЃС‚РёРєСѓ",
        "Р’Р·СЏР»Рё РїРѕРґ РєРѕРЅС‚СЂРѕР»СЊ РїРѕРєР°Р·Р°С‚РµР»Рё Рё СЃРЅРёР·РёР»Рё РІР»РёСЏРЅРёРµ С‡РµР»РѕРІРµС‡РµСЃРєРѕРіРѕ С„Р°РєС‚РѕСЂР°.",
        "https://yandex.ru/routing/articles/rossko/",
    ),
    _case(
        "novabev", "РќРѕРІР°Р±РµРІ", ("РђР»РєРѕРіРѕР»СЊ Рё С‚Р°Р±Р°Рє"),
        "20% СЌРєРѕРЅРѕРјРёРё РЅР° РІРЅСѓС‚СЂРёРіРѕСЂРѕРґСЃРєРѕР№ Р»РѕРіРёСЃС‚РёРєРµ",
        "РќР° 18,3% СЃРЅРёР·РёР»Рё РІСЂРµРјСЏ СЂР°Р±РѕС‚С‹ РІРѕРґРёС‚РµР»РµР№.",
    ),
    _case(
        "euromebel", "Euromebel", ("Р”РѕРј, СЂРµРјРѕРЅС‚, СЃР°Рґ"),
        "30% СЌРєРѕРЅРѕРјРёРё РЅР° Р»РѕРіРёСЃС‚РёРєРµ РґРѕСЃС‚Р°РІРєРё",
        "РћСЂРіР°РЅРёР·РѕРІР°Р»Рё С†РµРЅС‚СЂР°Р»РёР·РѕРІР°РЅРЅРѕРµ СѓРїСЂР°РІР»РµРЅРёРµ РґРѕСЃС‚Р°РІРєРѕР№ РїРѕ РІСЃРµР№ СЃС‚СЂР°РЅРµ.",
        "https://yandex.ru/routing/articles/euromebel/",
    ),
    _case(
        "sibur", "РЎРёР±СѓСЂ", ("РџСЂРѕРёР·РІРѕРґСЃС‚РІРѕ Рё РїСЂРѕРјС‹С€Р»РµРЅРЅРѕСЃС‚СЊ"),
        "350 С‚С‹СЃ. РїРµСЂРµРІРѕР·РѕРє РјРѕРЅРёС‚РѕСЂСЏС‚ РІ РіРѕРґ",
        "Р’СЂРµРјСЏ РїРѕР»СѓС‡РµРЅРёСЏ СЃС‚Р°С‚СѓСЃР° РґРѕСЃС‚Р°РІРєРё СЃРѕРєСЂР°С‚РёР»РѕСЃСЊ СЃ 2,5 С‡Р°СЃРѕРІ РґРѕ 30 СЃРµРєСѓРЅРґ.",
        "https://yandex.ru/routing/articles/sibur/",
    ),
    _case(
        "iceberry", "РђР№СЃР±РµСЂСЂРё", ("FMCG"),
        "10% СЃРЅРёР¶РµРЅРёРµ РїСЂРѕР±РµРіР°",
        "Р’РІРµР»Рё РЅРѕРІСѓСЋ РјРѕС‚РёРІР°С†РёСЋ РІРѕРґРёС‚РµР»РµР№ Рё РѕРєСѓРїРёР»Рё РїСЂРѕРµРєС‚ РІ РїРµСЂРІС‹Р№ РіРѕРґ.",
        "https://yandex.ru/routing/articles/iceberry/",
    ),
    _case(
        "skif_cargo", "РЎРєРёС„-РљР°СЂРіРѕ", ("Р›РѕРіРёСЃС‚РёРєР°"),
        "РќР° 20% СЃРЅРёР·РёР»Рё СЃС‚РѕРёРјРѕСЃС‚СЊ РїРµСЂРµРІРѕР·РєРё РјВі/РєРј",
        "Р”Рѕ 98% РІРѕР·СЂРѕСЃР»Рѕ РєРѕР»РёС‡РµСЃС‚РІРѕ СЃРІРѕРµРІСЂРµРјРµРЅРЅС‹С… РґРѕСЃС‚Р°РІРѕРє.",
        "https://rutube.ru/video/f8ade0a0b42b599f71e89d021699852d/?r=wd",
    ),
    _case(
        "perekrestok", "РџРµСЂРµРєСЂС‘СЃС‚РѕРє Р’РїСЂРѕРє", ("FMCG"),
        "31 800 в‚Ѕ РµР¶РµРґРЅРµРІРЅРѕР№ СЌРєРѕРЅРѕРјРёРё РЅР° РўРЎ",
        "95% РґРѕСЃС‚Р°РІРѕРє РїРѕРїР°РґР°СЋС‚ РІРѕ РІСЂРµРјРµРЅРЅС‹Рµ РёРЅС‚РµСЂРІР°Р»С‹.",
        "https://yandex.ru/routing/articles/perekrestok/",
    ),
    _case(
        "okraina", "РћРєСЂР°РёРЅР°", ("FMCG"),
        "в€’10% РёСЃРїРѕР»СЊР·СѓРµРјРѕРіРѕ С‚СЂР°РЅСЃРїРѕСЂС‚Р°",
        "РќРѕРІС‹С… Р»РѕРіРёСЃС‚РѕРІ РѕР±СѓС‡Р°СЋС‚ 2 РЅРµРґРµР»Рё РІРјРµСЃС‚Рѕ РїСЂРµР¶РЅРёС… 6 РјРµСЃСЏС†РµРІ.",
        "https://yandex.ru/routing/articles/okraina/",
    ),
    _case(
        "lavka", "РЇРЅРґРµРєСЃ Р›Р°РІРєР°", ("FMCG"),
        "РњРµРЅРµРµ 15 РјРёРЅСѓС‚ РґРѕСЂРѕРіРё РєСѓСЂСЊРµСЂР° РґРѕ РґР°СЂРєСЃС‚РѕСЂРѕРІ",
        "РњР°СЂС€СЂСѓС‚РёР·РёСЂСѓСЋС‚ РґРІСѓС…СѓСЂРѕРІРЅРµРІСѓСЋ Р»РѕРіРёСЃС‚РёРєСѓ: СЂР°СЃРїСЂРµРґРµР»РёС‚РµР»СЊРЅС‹Р№ С†РµРЅС‚СЂ в†’ РґР°СЂРєСЃС‚РѕСЂ в†’ РїРѕРєСѓРїР°С‚РµР»СЊ.",
        "https://yandex.ru/routing/articles/lavka/",
    ),
    _case(
        "askona", "Askona", ("Р”РѕРј, СЂРµРјРѕРЅС‚, СЃР°Рґ"),
        "Р РѕСЃС‚ РѕС†РµРЅРєРё РґРѕСЃС‚Р°РІРєРё РґРѕ 4,65",
        "РЎРЅРёР·РёР»Рё РґРѕР»СЋ РЅРµСЃРѕРіР»Р°СЃРѕРІР°РЅРЅС‹С… РёРЅС‚РµСЂРІР°Р»РѕРІ СЃ 3,6% РґРѕ 2,5%.",
        "https://yandex.ru/routing/articles/askona/",
    ),
    _case(
        "heidelbergcement", "HeidelbergCement", ("РџСЂРѕРёР·РІРѕРґСЃС‚РІРѕ Рё РїСЂРѕРјС‹С€Р»РµРЅРЅРѕСЃС‚СЊ"),
        "80 000+ РґРѕСЃС‚Р°РІРѕРє РѕС‚СЃР»РµР¶РёРІР°РµС‚СЃСЏ С‡РµСЂРµР· РјРѕРЅРёС‚РѕСЂРёРЅРі",
        "Р’ 2 СЂР°Р·Р° СЃРѕРєСЂР°С‚РёР»Рё РІСЂРµРјСЏ РѕР¶РёРґР°РЅРёСЏ Рё СЂР°Р·РіСЂСѓР·РєРё.",
        "https://yandex.ru/routing/articles/heidelbergcement/",
    ),
    _case(
        "baltika", "Р‘Р°Р»С‚РёРєР°", ("РђР»РєРѕРіРѕР»СЊ Рё С‚Р°Р±Р°Рє"),
        "98% РїРѕСЃС‚Р°РІРѕРє РѕС‚СЃР»РµР¶РёРІР°СЋС‚ РІ СЂРµР°Р»СЊРЅРѕРј РІСЂРµРјРµРЅРё",
        "РџР»РѕС‚РЅРѕСЃС‚СЊ РЅР° РјР°СЂС€СЂСѓС‚Рµ РІС‹СЂРѕСЃР»Р° РЅР° 15%, РІСЂРµРјСЏ РѕР±СЃР»СѓР¶РёРІР°РЅРёСЏ РјР°С€РёРЅ СЃРЅРёР·РёР»РѕСЃСЊ РЅР° 30%.",
        "https://yandex.ru/routing/articles/baltika/",
    ),
    _case(
        "kolomenskoe", "Р‘РљРљ В«РљРѕР»РѕРјРµРЅСЃРєРёР№В»", ("FMCG", "РҐР»РµР±РѕР±СѓР»РѕС‡РЅС‹Рµ РёР·РґРµР»РёСЏ"),
        "800+ С‚РѕСЂРіРѕРІС‹С… С‚РѕС‡РµРє РІ РµРґРёРЅРѕРј РєРѕРЅС‚СѓСЂРµ РїР»Р°РЅРёСЂРѕРІР°РЅРёСЏ",
        "РњР°СЂС€СЂСѓС‚РёР·РёСЂСѓСЋС‚ РЅРѕС‡РЅСѓСЋ Рё СЂР°РЅРЅСЋСЋ РґРѕСЃС‚Р°РІРєСѓ СЃРєРѕСЂРѕРїРѕСЂС‚СЏС‰РµР№СЃСЏ РїСЂРѕРґСѓРєС†РёРё РґР»СЏ 500 РјР°С€РёРЅ РµР¶РµРґРЅРµРІРЅРѕ.",
        "https://yandex.ru/routing/articles/kolomenskoe/",
    ),
    _case(
        "simple", "Simple Group", ("РђР»РєРѕРіРѕР»СЊ Рё С‚Р°Р±Р°Рє"),
        "в‰€23,4% РїРѕСЃС‚Р°РІРѕРє РѕС‚СЃР»РµР¶РёРІР°СЋС‚ РІ СЂРµР°Р»СЊРЅРѕРј РІСЂРµРјРµРЅРё",
        "РџР»РѕС‚РЅРѕСЃС‚СЊ РЅР° РјР°СЂС€СЂСѓС‚Рµ РІС‹СЂРѕСЃР»Р° РЅР° 15%, РІСЂРµРјСЏ РѕР±СЃР»СѓР¶РёРІР°РЅРёСЏ РјР°С€РёРЅ СЃРЅРёР·РёР»РѕСЃСЊ РЅР° 30%.",
        "https://yandex.ru/routing/articles/simple/",
    ),
    _case(
        "yandex_market", "РЇРЅРґРµРєСЃ РњР°СЂРєРµС‚", ("E-com"),
        "95% С‚РѕС‡РЅРѕСЃС‚СЊ РїРѕРїР°РґР°РЅРёСЏ РІРѕ РІСЂРµРјРµРЅРЅРѕР№ РёРЅС‚РµСЂРІР°Р» РґРѕСЃС‚Р°РІРєРё",
        "РђРІС‚РѕРјР°С‚РёР·Р°С†РёСЏ РїРѕРјРѕРіР»Р° РјР°СЃС€С‚Р°Р±РёСЂРѕРІР°С‚СЊСЃСЏ РЅР° РєСЂСѓРїРЅС‹Рµ РіРѕСЂРѕРґР° Рё РїРµСЂРµР№С‚Рё Рє СЃРѕР±СЃС‚РІРµРЅРЅРѕР№ СЃР»СѓР¶Р±Рµ РґРѕСЃС‚Р°РІРєРё.",
        "https://yandex.ru/routing/articles/yandex-market/",
    ),
    _case(
        "biocodex", "Р‘РёРѕРєРѕРґРµРєСЃ", ("РњРµРґРёС†РёРЅР° Рё С„Р°СЂРјР°С†РµРІС‚РёРєР°"),
        "Р”Рѕ 97% РєРѕРЅС‚Р°РєС‚РѕРІ РёР· Р±Р°Р·С‹ СѓСЃРїРµРІР°СЋС‚ РїРѕСЃРµС‚РёС‚СЊ РїСЂРµРґСЃС‚Р°РІРёС‚РµР»Рё",
        "Р•Р¶РµРЅРµРґРµР»СЊРЅРѕ РїР»Р°РЅРёСЂСѓСЋС‚ 4 500 РІРёР·РёС‚РѕРІ РґР»СЏ 75 РјРµРґРёС†РёРЅСЃРєРёС… РїСЂРµРґСЃС‚Р°РІРёС‚РµР»РµР№.",
    ),
    _case(
        "apteka_aprel", "РђРїС‚РµРєРё РђРїСЂРµР»СЊ", ("РњРµРґРёС†РёРЅР° Рё С„Р°СЂРјР°С†РµРІС‚РёРєР°"),
        "Р”Рѕ 99% СѓС‚РёР»РёР·Р°С†РёРё С‚СЂР°РЅСЃРїРѕСЂС‚Р°",
        "Р’СЂРµРјСЏ РїР»Р°РЅРёСЂРѕРІР°РЅРёСЏ РѕС‚РіСЂСѓР·РєРё СЃРЅРёР·РёР»Рё РІ 4 СЂР°Р·Р°.",
        "https://yandex.ru/routing/articles/apteka-aprel/",
    ),
    _case(
        "volga_ice", "Р’РѕР»РіР° РђР№СЃ", ("FMCG"),
        "Р”Рѕ 40 С‚РѕС‡РµРє РЅР° РјР°СЂС€СЂСѓС‚Рµ РІРјРµСЃС‚Рѕ 25",
        "РЎРѕС…СЂР°РЅРёР»Рё РєР°С‡РµСЃС‚РІРѕ вЂ” РјРѕСЂРѕР¶РµРЅРѕРµ РЅРµ С‚Р°РµС‚ РґР°Р¶Рµ РїСЂРё Р±РѕР»СЊС€РµРј РєРѕР»РёС‡РµСЃС‚РІРµ С‚РѕС‡РµРє.",
        "https://yandex.ru/routing/articles/volga-ice1/",
    ),
    _case(
        "sever_avto", "РЎРµРІРµСЂ РђРІС‚Рѕ", ("РђРІС‚РѕС‚РѕРІР°СЂС‹"),
        "100% РєР»РёРµРЅС‚РѕРІ РїРѕР»СѓС‡Р°СЋС‚ СѓРІРµРґРѕРјР»РµРЅРёСЏ Рѕ СЃС‚Р°С‚СѓСЃРµ РґРѕСЃС‚Р°РІРєРё",
        "Р’СЂРµРјСЏ РїР»Р°РЅРёСЂРѕРІР°РЅРёСЏ СЃРѕРєСЂР°С‚РёР»Рё РІ 2 СЂР°Р·Р°.",
        "https://yandex.ru/routing/articles/sever_avto/",
    ),
    _case(
        "gemotest", "Р“РµРјРѕС‚РµСЃС‚", ("РњРµРґРёС†РёРЅР° Рё С„Р°СЂРјР°С†РµРІС‚РёРєР°"),
        "РРЅС‚РµСЂРІР°Р» РІРёР·РёС‚Р° 2вЂ“3 С‡Р°СЃР° РІРјРµСЃС‚Рѕ С†РµР»РѕРіРѕ РґРЅСЏ",
        "РўРµРїРµСЂСЊ РїР°С†РёРµРЅС‚С‹ Р·РЅР°СЋС‚, РІ РєР°РєРѕРµ РІСЂРµРјСЏ РѕР¶РёРґР°С‚СЊ СЃРїРµС†РёР°Р»РёСЃС‚Р°.",
        "https://yandex.ru/routing/articles/gemotest/",
    ),
    _case(
        "fasco", "Р“Р°СЂРґРµРЅ Р РёС‚РµР№Р» РЎРµСЂРІРёСЃ (Р¤Р°СЃРєРѕ)", ("Р”РѕРј, СЂРµРјРѕРЅС‚, СЃР°Рґ"),
        "в€’7% Р·Р°С‚СЂР°С‚ РЅР° Р»РѕРіРёСЃС‚РёРєСѓ РїСЂРё СЂРѕСЃС‚Рµ С†РµРЅ РЅР° С‚СЂР°РЅСЃРїРѕСЂС‚",
        "РЎРѕРєСЂР°С‚РёР»Рё РїР»Р°РЅРёСЂРѕРІР°РЅРёРµ РјР°СЂС€СЂСѓС‚РѕРІ СЃ 2вЂ“3 С‡Р°СЃРѕРІ РґРѕ 40 РјРёРЅСѓС‚.",
        "https://yandex.ru/routing/articles/fasco/",
    ),
    _case(
        "bulka", "Р‘СѓР»РєР°", ("FMCG", "РҐР»РµР±РѕР±СѓР»РѕС‡РЅС‹Рµ РёР·РґРµР»РёСЏ"),
        "Р’ 2 СЂР°Р·Р° СЃРѕРєСЂР°С‚РёР»Р°СЃСЊ РїСЂРѕС‚СЏР¶С‘РЅРЅРѕСЃС‚СЊ РјР°СЂС€СЂСѓС‚РѕРІ",
        "РђРІС‚РѕРјР°С‚РёР·Р°С†РёСЏ РїРѕРґРґРµСЂР¶РёРІР°РµС‚ РїСЂРёР±С‹Р»СЊРЅРѕСЃС‚СЊ Р±РёР·РЅРµСЃР° РїСЂРё СЂРµР·РєРѕРј СЂРѕСЃС‚Рµ Р·Р°РєР°Р·РѕРІ Р±РµР· СЂР°СЃС€РёСЂРµРЅРёСЏ С€С‚Р°С‚Р°.",
        "https://yandex.ru/routing/articles/bulka/",
    ),
    _case(
        "baton", "РћРЅР»Р°Р№РЅ-Р±СѓР»РѕС‡РЅР°СЏ В«Р—Р°РєР°Р¶Рё Р‘Р°С‚РѕРЅВ»", ("FMCG", "РҐР»РµР±РѕР±СѓР»РѕС‡РЅС‹Рµ РёР·РґРµР»РёСЏ"),
        "Р’ 2 СЂР°Р·Р° СЃРѕРєСЂР°С‚РёР»Р°СЃСЊ РїСЂРѕС‚СЏР¶С‘РЅРЅРѕСЃС‚СЊ РјР°СЂС€СЂСѓС‚РѕРІ",
        "РџРѕРґРґРµСЂР¶Р°Р»Рё СЂРѕСЃС‚ СЃРїСЂРѕСЃР° СЃ 200 РґРѕ 3 000 Р·Р°РєР°Р·РѕРІ РІ РјРµСЃСЏС† Р±РµР· РїРѕС‚РµСЂРё РєР°С‡РµСЃС‚РІР°.",
        "https://yandex.ru/routing/articles/baton/",
    ),
    _case(
        "vishera", "Р’РёС€РµСЂР°-РџР»СЋСЃ", ("FMCG"),
        "в€’13% РїСЂРѕР±РµРіР° С‚СЂР°РЅСЃРїРѕСЂС‚Р°",
        "РЎРѕРєСЂР°С‚РёР»Рё С…РѕР»РѕСЃС‚РѕР№ С…РѕРґ РЅР° 2вЂ“4 С‡Р°СЃР° РІ РґРµРЅСЊ.",
        "https://yandex.ru/routing/articles/vishera-plus/",
    ),
    _case(
        "love_pirogova", "Р›СЋР±РѕРІСЊ РџРёСЂРѕРіРѕРІР°", ("FMCG"),
        "+70% СЃРєРѕСЂРѕСЃС‚Рё РїР»Р°РЅРёСЂРѕРІР°РЅРёСЏ",
        "РџРѕРїР°РґР°СЋС‚ РІ РёРЅС‚РµСЂРІР°Р» РґРѕСЃС‚Р°РІРєРё СЃ РІРµСЂРѕСЏС‚РЅРѕСЃС‚СЊСЋ 95%.",
        "https://yandex.ru/routing/articles/lovepirogova/",
    ),
    _case(
        "expoparts", "Expoparts", ("РђРІС‚РѕС‚РѕРІР°СЂС‹"),
        "Р РѕСЃС‚ СЃ 7вЂ“8 РґРѕ 13вЂ“15 Р·Р°РєР°Р·РѕРІ РІ СЃСѓС‚РєРё РЅР° РІРѕРґРёС‚РµР»СЏ",
        "РЎРІРµР»Рё Рє РЅСѓР»СЋ РЅРµРґРѕРІРѕР·С‹ Рё РІРЅРµРґСЂРёР»Рё РґРѕСЃС‚Р°РІРєСѓ РІ РґРµРЅСЊ Р·Р°РєР°Р·Р°.",
        "https://yandex.ru/routing/articles/expoparts/",
    ),
    _case(
        "mariara", "РњР°СЂРёСЏ-Р Р°", ("FMCG"),
        "Р”Рѕ 400 РєРј СЂР°РґРёСѓСЃ РґРѕСЃС‚Р°РІРєРё СЃРІРµР¶РёС… РїСЂРѕРґСѓРєС‚РѕРІ",
        "Р РµР°Р»РёР·СѓСЋС‚ РјР°СЂС€СЂСѓС‚РёР·Р°С†РёСЋ С‚СЏРіР°С‡РµР№ СЃ РїСЂРёС†РµРїР°РјРё Рё РјРЅРѕРіРѕРґРЅРµРІРЅС‹Рµ РјР°СЂС€СЂСѓС‚С‹.",
        "https://yandex.ru/routing/articles/mariara/",
    ),
    _case(
        "bianca", "BIANCA", ("РЎРµСЂРІРёСЃРЅС‹Рµ СѓСЃР»СѓРіРё"),
        "Р”Рѕ 99% РїРѕРїР°РґР°РЅРёСЏ РІРѕ РІСЂРµРјРµРЅРЅРѕР№ РёРЅС‚РµСЂРІР°Р»",
        "РџР»Р°РЅРёСЂРѕРІР°РЅРёРµ РјР°СЂС€СЂСѓС‚РѕРІ Р·Р°РЅРёРјР°РµС‚ РѕС‚ 10 РјРёРЅСѓС‚.",
        "https://yandex.ru/routing/articles/bianca/",
    ),
    _case(
        "petline", "Pet Line", ("FMCG"),
        "Р’ 1,5вЂ“2 СЂР°Р·Р° СѓРІРµР»РёС‡РёР»Рё РєРѕР»РёС‡РµСЃС‚РІРѕ РІС‹РїРѕР»РЅСЏРµРјС‹С… Р·Р°СЏРІРѕРє",
        "Р’СЂРµРјСЏ РЅР° РїР»Р°РЅРёСЂРѕРІР°РЅРёРµ СЃРѕРєСЂР°С‚РёР»Рё РІ 6 СЂР°Р·.",
        "https://yandex.ru/routing/articles/petline/",
    ),
    _case(
        "raiffeisen", "Raiffeisen Bank", ("Р‘Р°РЅРєРё Рё С„РёРЅР°РЅСЃС‹"),
        "Р’ 2 СЂР°Р·Р° РІС‹СЂРѕСЃР»Р° СЌС„С„РµРєС‚РёРІРЅРѕСЃС‚СЊ РІС‹РµР·РґРЅС‹С… РєРѕРЅСЃСѓР»СЊС‚Р°РЅС‚РѕРІ",
        "Р”РѕР»СЏ Р·Р°РєР°Р·РѕРІ, РґРѕСЃС‚Р°РІР»СЏРµРјС‹С… РЅР° СЃР»РµРґСѓСЋС‰РёР№ РґРµРЅСЊ, РІС‹СЂРѕСЃР»Р° РЅР° 13%.",
        "https://yandex.ru/routing/articles/raiffeisen/",
    ),
    _case(
        "gkb52", "Р“РѕСЂРѕРґСЃРєР°СЏ РєР»РёРЅРёС‡РµСЃРєР°СЏ Р±РѕР»СЊРЅРёС†Р° в„– 52", ("РњРµРґРёС†РёРЅР° Рё С„Р°СЂРјР°С†РµРІС‚РёРєР°"),
        "Р’ 2,5 СЂР°Р·Р° СЃРѕРєСЂР°С‚РёР»Р°СЃСЊ РѕР±С‰Р°СЏ РґР»РёС‚РµР»СЊРЅРѕСЃС‚СЊ РјР°СЂС€СЂСѓС‚Р°",
        "РњР°СЂС€СЂСѓС‚РёР·РёСЂСѓСЋС‚ РґРѕСЃС‚Р°РІРєСѓ РїР°С†РёРµРЅС‚РѕРІ РґРѕРјРѕР№ СЃ СѓС‡С‘С‚РѕРј РєРѕРјС„РѕСЂС‚РЅРѕРіРѕ РІСЂРµРјРµРЅРё РІ РїСѓС‚Рё.",
        "https://yandex.ru/routing/articles/gkb52/",
    ),
    _case(
        "valta", "Р’Р°Р»С‚Р° РџРµС‚ РџСЂРѕРґР°РєС‚СЃ", ("FMCG"),
        "РњР°СЃС€С‚Р°Р±РёСЂРѕРІР°РЅРёРµ РЅР° 55 РіРѕСЂРѕРґРѕРІ Р±РµР· СѓРІРµР»РёС‡РµРЅРёСЏ С€С‚Р°С‚Р° Р»РѕРіРёСЃС‚РѕРІ",
        "Р’СЂРµРјСЏ РјР°СЂС€СЂСѓС‚РёР·Р°С†РёРё СЃРѕРєСЂР°С‚РёР»Рё РІ 4 СЂР°Р·Р°.",
        "https://yandex.ru/routing/articles/valta/",
    ),
    _case(
        "repropark", "ReproРџР°СЂРє", ("РџСЂРѕРёР·РІРѕРґСЃС‚РІРѕ Рё РїСЂРѕРјС‹С€Р»РµРЅРЅРѕСЃС‚СЊ"),
        "20% СЃРЅРёР¶РµРЅРёРµ РІСЂРµРјРµРЅРё РґРѕСЃС‚Р°РІРєРё РїРѕ РњРѕСЃРєРІРµ",
        "Р’РІРµР»Рё РµРґРёРЅС‹Р№ РёРЅСЃС‚СЂСѓРјРµРЅС‚ РєРѕРЅС‚СЂРѕР»СЏ KPI РІРѕРґРёС‚РµР»РµР№ Рё Р°РЅР°Р»РёС‚РёРєРё РїСЂРѕС†РµСЃСЃРѕРІ.",
        "https://yandex.ru/routing/articles/repropark/",
    ),
    _case(
        "holodilnik", "РҐРѕР»РѕРґРёР»СЊРЅРёРє.СЂСѓ", ("Р”РѕРј, СЂРµРјРѕРЅС‚, СЃР°Рґ"),
        "в€’15% Р·Р°С‚СЂР°С‚ РЅР° РїРѕСЃР»РµРґРЅСЋСЋ РјРёР»СЋ",
        "РџРѕРІС‹СЃРёР»Рё РґРѕСЃС‚Р°РІР»СЏРµРјРѕСЃС‚СЊ Р·Р°РєР°Р·РѕРІ РЅР° 4%.",
        "https://yandex.ru/routing/articles/holodilnik/",
    ),
    _case(
        "santekhnika", "РЎР°РЅС‚РµС…РЅРёРєР° РћРЅР»Р°Р№РЅ", ("Р”РѕРј, СЂРµРјРѕРЅС‚, СЃР°Рґ"),
        "Р’ 6 СЂР°Р· СЃРѕРєСЂР°С‚РёР»РѕСЃСЊ РІСЂРµРјСЏ РјР°СЂС€СЂСѓС‚РёР·Р°С†РёРё",
        "РЈСЂРѕРІРµРЅСЊ РІС‹РєСѓРїР°РµРјРѕСЃС‚Рё Р·Р°РєР°Р·РѕРІ СЃ РјР°СЂС€СЂСѓС‚Р° РІС‹СЂРѕСЃ РЅР° 6вЂ“7%.",
        "https://yandex.ru/routing/articles/santekhnika-online/",
    ),
    _case(
        "sunlight", "SUNLIGHT", ("Р РёС‚РµР№Р»"),
        "РЎ 20 РґРѕ 25 Р·Р°РєР°Р·РѕРІ РЅР° РјР°СЂС€СЂСѓС‚Рµ РѕРґРЅРѕРіРѕ РєСѓСЂСЊРµСЂР°",
        "РЈСЂРѕРІРµРЅСЊ СѓРґРѕРІР»РµС‚РІРѕСЂС‘РЅРЅРѕСЃС‚Рё РєР»РёРµРЅС‚РѕРІ РїРѕ РёС‚РѕРіР°Рј РґРѕСЃС‚Р°РІРєРё РІС‹СЂРѕСЃ РЅР° 4%.",
        "https://yandex.ru/routing/articles/sunlight/",
    ),
    _case(
        "kidsway", "KidsWay", ("РЎРµСЂРІРёСЃРЅС‹Рµ СѓСЃР»СѓРіРё"),
        "в‰€15 РјРёРЅСѓС‚ РІСЂРµРјСЏ РїРѕСЃС‚СЂРѕРµРЅРёСЏ РјР°СЂС€СЂСѓС‚Р°",
        "РЎРёСЃС‚РµРјР° Р°РґР°РїС‚РёСЂСѓРµС‚СЃСЏ Рє РёР·РјРµРЅРµРЅРёСЏРј СЂР°СЃРїРёСЃР°РЅРёСЏ Рё РїРѕР·РІРѕР»СЏРµС‚ РґРѕРїР»Р°РЅРёСЂРѕРІР°С‚СЊ СЂР°Р·РѕРІС‹Рµ Р·Р°РєР°Р·С‹.",
        "https://yandex.ru/routing/articles/kidsway/",
    ),
    _case(
        "justfood", "Justfood", ("FMCG"),
        "в€’17% Р·Р°С‚СЂР°С‚ РЅР° РґРѕСЃС‚Р°РІРєСѓ",
        "РџРµСЂРµС€Р»Рё РЅР° РЅРѕРІСѓСЋ СЃРёСЃС‚РµРјСѓ РјР°СЂС€СЂСѓС‚РёР·Р°С†РёРё Рё СЃРЅРёР·РёР»Рё СЂР°СЃС…РѕРґС‹ РµС‰С‘ РґРѕ РїРѕР»РЅРѕРіРѕ РІРЅРµРґСЂРµРЅРёСЏ.",
...
def _cases_normalize(value: str) -> str:
    value = html_lib.unescape(str(value or "")).casefold().replace("С‘", "Рµ")
    return re.sub(r"[^0-9a-zР°-СЏ]+", " ", value).strip()


def _cases_token_matches(token: str, search_blob: str) -> bool:
    if token in search_blob:
        return True
    # РЈС‡РёС‚С‹РІР°РµРј СЂСѓСЃСЃРєРёРµ РѕРєРѕРЅС‡Р°РЅРёСЏ: РЅР°РїСЂРёРјРµСЂ, В«РїРѕСЃР»РµРґРЅСЏСЏ РјРёР»СЏВ» Рё
    # В«РїРѕСЃР»РµРґРЅСЋСЋ РјРёР»СЋВ» РґРѕР»Р¶РЅС‹ РЅР°С…РѕРґРёС‚СЊСЃСЏ РѕРґРЅРёРј Р·Р°РїСЂРѕСЃРѕРј.
    if len(token) < 3:
        return False
    stem = token[:3] if re.search(r"[Р°-СЏ]", token) else token[:4]
        ...
        search_blob = _cases_normalize(
            " ".join(
                [
                    ...
                    "РєРµР№СЃ Р»РѕРіРёСЃС‚РёРєР° РґРѕСЃС‚Р°РІРєР° РјР°СЂС€СЂСѓС‚С‹ РјР°СЂС€СЂСѓС‚РёР·Р°С†РёСЏ РїР»Р°РЅРёСЂРѕРІР°РЅРёРµ С‚СЂР°РЅСЃРїРѕСЂС‚",
                ]
            )
        )
...
def kb_cases_categories(user_id: int | None = None) -> InlineKeyboardMarkup:
    ...
    rows = [[InlineKeyboardButton("рџ“љ Р’СЃРµ РєРµР№СЃС‹", callback_data="help:cases:cat:all:0")]]
    rows.append(
        [
            InlineKeyboardButton(
                f"рџЋЇ РњРѕСЏ РѕС‚СЂР°СЃР»СЊ: {selected_label}" if selected_label else "рџЋЇ РњРѕСЏ РѕС‚СЂР°СЃР»СЊ",
                callback_data="help:cases:industry",
            )
        ]
    )
    # Р“СЂСѓРїРїРёСЂСѓРµРј РєРЅРѕРїРєРё РїРѕ РґРІРµ РІ СЃС‚СЂРѕРєРµ, СЃРѕС…СЂР°РЅСЏСЏ СЃРѕСЂС‚РёСЂРѕРІРєСѓ РѕС‚СЂР°СЃР»РµР№
    # РїРѕ РґР»РёРЅРµ РЅР°Р·РІР°РЅРёСЏ.
    category_buttons = [
    ...
    rows.extend(
        [
            [InlineKeyboardButton("рџ”Ћ РџРѕРёСЃРє РїРѕ РєРµР№СЃР°Рј", callback_data="help:cases:search")],
            [InlineKeyboardButton("в­ђ РР·Р±СЂР°РЅРЅС‹Рµ РєРµР№СЃС‹", callback_data="help:cases:favorites:0")],
            [InlineKeyboardButton("в¬…пёЏ Р“Р»Р°РІРЅРѕРµ РјРµРЅСЋ", callback_data="help:main")],
        ]
    )
    return InlineKeyboardMarkup(rows)
...
def cases_menu_text(user_id: int | None = None) -> str:
    ...
    selected_label = CASES_CATEGORY_LABELS.get(selected_key or "", "")
    industry_line = (
        f"\nрџЋЇ <b>РњРѕСЏ РѕС‚СЂР°СЃР»СЊ:</b> {escape(selected_label)}\n"
        "РљРЅРѕРїРєР° В«РњРѕСЏ РѕС‚СЂР°СЃР»СЊВ» РїРѕР·РІРѕР»СЏРµС‚ РёР·РјРµРЅРёС‚СЊ РёР»Рё СѓР±СЂР°С‚СЊ С„РёР»СЊС‚СЂ.\n"
        if selected_label
        else "\nрџЋЇ РњРѕСЏ РѕС‚СЂР°СЃР»СЊ РїРѕРєР° РЅРµ РІС‹Р±СЂР°РЅР°.\n"
    )
    return (
        "рџ“љ <b>РљРµР№СЃС‹ РЇРЅРґРµРєСЃ РњР°СЂС€СЂСѓС‚РёР·Р°С†РёРё</b>\n\n"
        f"{industry_line}\n"
        "Р’С‹Р±РµСЂРёС‚Рµ РѕС‚СЂР°СЃР»СЊ РёР»Рё РЅР°Р№РґРёС‚Рµ РєРµР№СЃ РїРѕ РЅР°Р·РІР°РЅРёСЋ РєРѕРјРїР°РЅРёРё, "
        "РѕС‚СЂР°СЃР»Рё Рё РєР»СЋС‡РµРІС‹Рј СЃР»РѕРІР°Рј."
    )
...
def kb_cases_industry_picker(user_id: int | None = None) -> InlineKeyboardMarkup:
    ...
    category_buttons = [
        InlineKeyboardButton(
            f"{'вњ… ' if key == selected_key else ''}{label}",
    ...
    if selected_key:
        rows.append(
            [
                InlineKeyboardButton(
                    "рџ“‚ РџРѕРєР°Р·Р°С‚СЊ РєРµР№СЃС‹ РјРѕРµР№ РѕС‚СЂР°СЃР»Рё",
        ...
        rows.append(
            [
                InlineKeyboardButton(
                    "рџ§№ РЈР±СЂР°С‚СЊ РјРѕСЋ РѕС‚СЂР°СЃР»СЊ",
                    callback_data="help:cases:industry:clear",
                )
            ]
        )
    rows.append([InlineKeyboardButton("в¬…пёЏ Рљ РєРµР№СЃР°Рј", callback_data="help:cases")])
    return InlineKeyboardMarkup(rows)
...
def cases_list_text(
    ...
    empty_text: str = "РќРёС‡РµРіРѕ РЅРµ РЅР°Р№РґРµРЅРѕ.",
) -> tuple[str, int, int]:
    page_items, page, total_pages = _cases_page(items, page)
    if heading:
        title = heading
    elif query:
        title = f"рџ”Ћ <b>Р РµР·СѓР»СЊС‚Р°С‚С‹ РїРѕРёСЃРєР°</b>\nР—Р°РїСЂРѕСЃ: <b>{escape(query)}</b>"
    else:
        label = CASES_CATEGORY_LABELS.get(category_key, CASES_CATEGORY_LABELS["all"])
        title = f"рџ“љ <b>{escape(label)}</b>"
    if not items:
        return f"{title}\n\n{empty_text}", page, total_pages
    lines = [title, f"\nРќР°Р№РґРµРЅРѕ РєРµР№СЃРѕРІ: <b>{len(items)}</b>", "\nР’С‹Р±РµСЂРёС‚Рµ РєРѕРјРїР°РЅРёСЋ:"]
    for item in page_items:
        lines.append(f"вЂў {escape(item['company'])}")
    if total_pages > 1:
        lines.append(f"\nРЎС‚СЂР°РЅРёС†Р° {page + 1} РёР· {total_pages}")
...
def cases_my_industry_view(
    ...
    """Р РµРЅРґРµСЂРёС‚ С‚РѕР»СЊРєРѕ РєРµР№СЃС‹ СЃРѕС…СЂР°РЅС‘РЅРЅРѕР№ РѕС‚СЂР°СЃР»Рё Р±РµР· РѕСЃС‚Р°Р»СЊРЅС‹С… СЂР°Р·РґРµР»РѕРІ РєР°С‚Р°Р»РѕРіР°."""
    selected_key = db_case_get_industry(user_id)
    if not selected_key:
        return None
    ...
    list_text, page, _ = cases_list_text(
        ...
        page=page,
        heading=f"рџЋЇ <b>РњРѕСЏ РѕС‚СЂР°СЃР»СЊ: {escape(label)}</b>",
    )
    if notice:
        list_text = f"{notice}\n\n{list_text}"
...
def kb_cases_list(
    ...
    if total_pages > 1:
        ...
        if page > 0:
            ...
            nav.append(InlineKeyboardButton("в—ЂпёЏ", callback_data=callback))
        nav.append(InlineKeyboardButton(f"{page + 1} / {total_pages}", callback_data="noop"))
        if page < total_pages - 1:
            if industry:
                callback = f"help:cases:my_cases:{page + 1}"
            ...
            nav.append(InlineKeyboardButton("в–¶пёЏ", callback_data=callback))
        rows.append(nav)
    if industry:
        rows.append([
            InlineKeyboardButton("рџ”„ РЎРјРµРЅРёС‚СЊ РѕС‚СЂР°СЃР»СЊ", callback_data="help:cases:industry")
        ])
        rows.append([
            InlineKeyboardButton("рџ§№ РЈР±СЂР°С‚СЊ РјРѕСЋ РѕС‚СЂР°СЃР»СЊ", callback_data="help:cases:industry:clear")
        ])
    else:
        rows.append([InlineKeyboardButton("рџ”Ћ РџРѕРёСЃРє РїРѕ РєРµР№СЃР°Рј", callback_data="help:cases:search")])
        rows.append([
            InlineKeyboardButton(
                "в¬…пёЏ Рљ РєР°С‚РµРіРѕСЂРёСЏРј" if favorites or not query else "в¬…пёЏ Рљ СЂРµР·СѓР»СЊС‚Р°С‚Р°Рј",
                callback_data=(
                    "help:cases"
...
def cases_detail_text(item: dict) -> str:
    ...
    return (
        f"рџЏў <b>{escape(item['company'])}</b>\n"
        f"рџЏ· РћС‚СЂР°СЃР»СЊ: <b>{escape(categories)}</b>\n\n"
        f"рџ“Љ <b>{escape(item['metric'])}</b>\n\n"
        "вњ… <b>Р§С‚Рѕ СЃРґРµР»Р°Р»Рё Рё РѕСЃРЅРѕРІРЅС‹Рµ РїСЂРµРёРјСѓС‰РµСЃС‚РІР°:</b>\n"
        f"вЂў {escape(item['summary'])}"
    )
...
def kb_case_detail(
    ...
    return InlineKeyboardMarkup(
        [
            [
                InlineKeyboardButton(
                    "в… РЈР±СЂР°С‚СЊ РёР· РёР·Р±СЂР°РЅРЅС‹С… РєРµР№СЃРѕРІ"
                    if marked else "в† Р”РѕР±Р°РІРёС‚СЊ РІ РёР·Р±СЂР°РЅРЅС‹Рµ РєРµР№СЃС‹",
                    callback_data=favorite_callback,
                )
            ],
            [InlineKeyboardButton("рџ”— РџРѕРґСЂРѕР±РЅРµРµ РЅР° СЃР°Р№С‚Рµ", url=item["url"])],
            [InlineKeyboardButton("в¬…пёЏ РќР°Р·Р°Рґ Рє СЃРїРёСЃРєСѓ", callback_data=back_callback)],
            [InlineKeyboardButton("рџ“љ Рљ РєР°С‚РµРіРѕСЂРёСЏРј", callback_data="help:cases")],
            [InlineKeyboardButton("рџЏ  Р“Р»Р°РІРЅРѕРµ РјРµРЅСЋ", callback_data="help:main")],
        ]
    )
...
async def handle_cases_search_text(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if len(query_text) < 2:
        await update.message.reply_text("Р’РІРµРґРёС‚Рµ РјРёРЅРёРјСѓРј 2 СЃРёРјРІРѕР»Р° РґР»СЏ РїРѕРёСЃРєР° РїРѕ РєРµР№СЃР°Рј.")
        return
...
async def handle_cases_callback(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if data == "help:cases:industry":
        ...
        if selected_key:
            ...
            if my_industry:
                ...
                return
        await query.edit_message_text(
            "рџЋЇ <b>РњРѕСЏ РѕС‚СЂР°СЃР»СЊ</b>\n\n"
            + (
                f"РЎРµР№С‡Р°СЃ РІС‹Р±СЂР°РЅР°: <b>{escape(selected_label)}</b>\n"
                "Р’С‹Р±РµСЂРёС‚Рµ РґСЂСѓРіСѓСЋ РѕС‚СЂР°СЃР»СЊ РёР»Рё СѓР±РµСЂРёС‚Рµ С‚РµРєСѓС‰СѓСЋ.\n"
                if selected_label
                else "Р’С‹Р±РµСЂРёС‚Рµ РѕС‚СЂР°СЃР»СЊ, С‡С‚РѕР±С‹ РІ РѕРґРёРЅ РєР»РёРє РѕС‚РєСЂС‹РІР°С‚СЊ РїРѕРґС…РѕРґСЏС‰РёРµ РєРµР№СЃС‹.\n"
            ),
            parse_mode=ParseMode.HTML,
    ...
    if data.startswith("help:cases:industry:set:"):
        key = data.rsplit(":", 1)[-1]
        if key not in CASES_CATEGORY_LABELS or key == "all":
            await query.answer("РќРµРёР·РІРµСЃС‚РЅР°СЏ РѕС‚СЂР°СЃР»СЊ.", show_alert=True)
            return
        ...
        await query.edit_message_text(
            f"вњ… РћС‚СЂР°СЃР»СЊ СЃРѕС…СЂР°РЅРµРЅР°.\n\n{list_text}",
            parse_mode=ParseMode.HTML,
    ...
    if data == "help:cases:industry:clear":
        ...
        await query.answer("Р¤РёР»СЊС‚СЂ РѕС‚СЂР°СЃР»Рё СѓР±СЂР°РЅ.")
        await query.edit_message_text(
            cases_menu_text(user_id),
            parse_mode=ParseMode.HTML,
            reply_markup=kb_cases_categories(user_id),
    ...
    if data == "help:cases:my_cases" or data.startswith("help:cases:my_cases:"):
        ...
        if not selected_key:
            await query.edit_message_text(
                "рџЋЇ <b>РњРѕСЏ РѕС‚СЂР°СЃР»СЊ</b>\n\nРЎРЅР°С‡Р°Р»Р° РІС‹Р±РµСЂРёС‚Рµ РѕС‚СЂР°СЃР»СЊ.",
                parse_mode=ParseMode.HTML,
                reply_markup=kb_cases_industry_picker(user_id),
            )
            return
    ...
    if data == "help:cases:search":
        ...
        context.user_data.pop(CASES_SEARCH_QUERY, None)
        await query.edit_message_text(
            "рџ”Ћ <b>РџРѕРёСЃРє РїРѕ РєРµР№СЃР°Рј</b>\n\n"
            "Р’РІРµРґРёС‚Рµ РЅР°Р·РІР°РЅРёРµ РєРѕРјРїР°РЅРёРё, РѕС‚СЂР°СЃР»СЊ РёР»Рё РєР»СЋС‡РµРІРѕРµ СЃР»РѕРІРѕ.\n"
            "РќР°РїСЂРёРјРµСЂ: <code>РјРµРґРёС†РёРЅР°</code>, <code>РїРѕСЃР»РµРґРЅСЏСЏ РјРёР»СЏ</code> РёР»Рё <code>РјР°СЂС€СЂСѓС‚С‹</code>.",
            parse_mode=ParseMode.HTML,
            reply_markup=InlineKeyboardMarkup(
                [[InlineKeyboardButton("вќЊ РћС‚РјРµРЅР°", callback_data="help:cases")]]
            ),
        )
        return
    ...
    if data == "help:cases:favorites" or data.startswith("help:cases:favorites:"):
        ...
        list_text, page, _ = cases_list_text(
            items,
            page=page,
            heading="в­ђ <b>РР·Р±СЂР°РЅРЅС‹Рµ РєРµР№СЃС‹</b>",
            empty_text="Р’С‹ РµС‰С‘ РЅРµ РґРѕР±Р°РІРёР»Рё РЅРё РѕРґРЅРѕРіРѕ РєРµР№СЃР° РІ РёР·Р±СЂР°РЅРЅРѕРµ.",
        )
        await query.edit_message_text(
            list_text,
            parse_mode=ParseMode.HTML,
    ...
    if data.startswith("help:cases:favorite:"):
        ...
        if not item or source not in ("s", "c", "f", "m"):
            await query.answer("РљРµР№СЃ РЅРµ РЅР°Р№РґРµРЅ.", show_alert=True)
            return
        if source == "s":
            try:
        ...
        try:
            ...
            pass
        await query.answer(
            "РљРµР№СЃ РґРѕР±Р°РІР»РµРЅ РІ РёР·Р±СЂР°РЅРЅРѕРµ." if marked
            else "РљРµР№СЃ СѓР±СЂР°РЅ РёР· РёР·Р±СЂР°РЅРЅРѕРіРѕ."
        )
        return
    ...
    if data == "help:cases:search_results" or data.startswith("help:cases:search_results:"):
        ...
        if not query_text:
            context.user_data[CASES_WAITING_SEARCH] = True
            await query.edit_message_text(
                "рџ”Ћ Р’РІРµРґРёС‚Рµ Р·Р°РїСЂРѕСЃ РґР»СЏ РїРѕРёСЃРєР° РїРѕ РєРµР№СЃР°Рј.",
                reply_markup=InlineKeyboardMarkup(
                    [[InlineKeyboardButton("вќЊ РћС‚РјРµРЅР°", callback_data="help:cases")]]
                ),
            )
