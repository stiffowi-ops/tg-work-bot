...
Желаем классного старта и вдохновения каждый день 🌟
Если что — не стесняйся, всегда поможем 🙌
Для знакомства с рабочим ботом используй команду /help ✅"""
...
INDUSTRY_GREETINGS = [
    "Коллеги, время отраслевой встречи — зарядимся идеями! 🚀",
    "Привет! Сегодня обсудим ключевые отраслевые новости ☕✨",
]
