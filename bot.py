...
def help_text_main(bot_username: str) -> str:
    return (
        ...
        "📄 <b>Документы</b> — регламенты, инструкции, файлы\n"
        "🔗 <b>Полезные ссылки</b> — сервисы и ресурсы для работы\n"
        "👥 <b>Краткая инфо о команде</b> — кто есть кто\n"
        "❓ <b>FAQ и калькулятор премии</b> — ответы и быстрые расчёты\n"
        "💡 <b>Предложка</b> — идеи и улучшения\n"
    )
