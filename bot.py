...
"
        "📄 Документы — регламенты, инструкции, файлы
"
        "🔗 Полезные ссылки — сервисы и ресурсы для работы
"
        "👥 Краткая инфо о команде — кто есть кто
"
        "❓ FAQ и калькулятор премии — ответы на вопросы и быстрые расчёты
"
        "💡 Предложка — идеи и улучшения для команды
"
    )
