...
russian_word_categories = {
    "технологии": [
        "КРИПТОПРОЦЕССОР", "ПРОГРАММА", "АУДИОИНТЕРФЕЙС", "УЯЗВИМОСТЬ", "ПРИЛОЖЕНИЕ", "ИННОВАЦИЯ", "РАЗРАБОТКА",
        "АЛГОРИТМ", "ФРЕЙМВОРК", "НАНОТЕХНОЛОГИИ", "КИБЕРАТАКА",
        "МИКРОКОНТРОЛЛЕР", "БЛОКЧЕЙН", "КИБЕРПРОСТРАНСТВО", "СВЕТОДИСПЛЕЙ", "МАРШРУТИЗАТОР"
    ],
    
    "животные": [
        "КИТОГЛАВ", "МЕДОЕД", "ЗЕМЛЕРОЙКА", "ПЕРОКРЫЛКА", "ГЕЛИКОПРИОН", "ГЛИПТОДОН", "МОЗАЗАВР", "ДИЦИНОДОНТ",
        "ЯСТРЕБ", "ПАНГОЛИН", "АЛЛИГАТОР", "ГИМНУРА", "ЯЩЕРИЦА", "ЖУЖЕЛИЦА"
    ],
    
    "города": [
        "СЕМИПАЛАТИНСК", "КОНСТАНТИНОПОЛЬ", "КАРФАГЕН", "ЕКАТЕРИНБУРГ", "АШХАБАД",
        "КАРАЧИ", "ДЖАКАРТА", "ПНОМПЕНЬ", "ЛЮБЛЯНА", "ЙОХАННЕСБУРГ", "ЧЕДЖУ", "ДАРМШТАДТ", "ВИНДХУК"
    ],
    
    "еда": [
        "ХАКАРЛЬ", "БАЛУТ", "СЮРСТРЕММИНГ", "ШИРАКО", "КИВИАК", "АСАФЕТИДА", "СУМАХ", "ТАРХАНА",
        "КУЛЕШ", "КАЛАКЕЙТТО", "ТАНГЦЫ", "МИТЛАЙМА", "БОТВИНЬЯ", "БОРМОТУХА", "ТЕГУИНО", "КАХВА",
        "МАСТИКА", "АКВАВИТ", "АБСЕНТ"
    ],
    
    "спорт": [
        "БОССАБОЛ", "ХОРНИНГ", "КАБАДДИ", "ШИНТИ", "БУЗКАШИ", "БЕЙСБОЛ",
        "ПЭСАНК", "АЙСШТОК", "БОЛЛИНГТОН", "СКВОШ", "ЛАКРОСС", "КИЛА", "ТХЭКВОНДО", "ФЕХТОВАНИЕ",
        
    ],
    
    "профессии": [
        "АНАСТЕЗИОЛОГ", "СПЕЛЕСТОЛОГ", "ПАТОФИЗИОЛОГ", "БИОИНФОРМАТИК", "НЕЙРОПСИХОЛОГ",
        "РЕСТАВРАТОР", "МАТРИЦАРХ", "СМЕТЧИК", "КОПИРАЙТЕР", "ПАЛЕОГЕНЕТИК",
    ],
    
    "природа": [
        "КРИПТОБИОЗ", "ПАЛЕОЭНДЕМИК", "СУКЦЕССИЯ", "КЕЛИМУТУ", "ЭЙЯФЬЯДЛАЙЕКЮДЛЬ", "ПОПОКАТЕПЕТЛЬ",
        "СУХОНА", "КАТРИНА", "АТАКАМА", "ТАСМАНИЯ", 
    ]
}
...
{eliminated_text}
💡 *ПРАВИЛА ИГРЫ:*
• Нажимаете "Присоединиться" и пишите по ОДНОЙ букве в чат
• Или попробуйте угадать слово целиком (выбываете при ошибке)
• ОШИБКА - будет стоить тебе факта о себе
