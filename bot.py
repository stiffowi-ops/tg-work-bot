...
def _notification_is_test(item: dict | None) -> bool:
    """Р’РѕР·РІСЂР°С‰Р°РµС‚ True РґР»СЏ СѓРІРµРґРѕРјР»РµРЅРёР№, СЃРІСЏР·Р°РЅРЅС‹С… СЃ РЅР°Р·РЅР°С‡РµРЅРёРµРј/РїСЂРѕС…РѕР¶РґРµРЅРёРµРј С‚РµСЃС‚Р°."""
    if not item:
        return False
    notification_type = str(item.get("notification_type") or "").lower()
    callback_data = str(item.get("callback_data") or "").lower()
    return (
        notification_type.startswith("test")
        or callback_data.startswith("test:")
        or callback_data.startswith("help:testv2:")
        or callback_data.startswith("help:me:test:")
        or callback_data.startswith("help:me:tests")
    )
...
async def cb_test(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if action == "start" and len(parts) >= 3:
        ...
        # РЎС‚Р°СЂС‹Рµ inline-РєРЅРѕРїРєРё Рё СЃСЃС‹Р»РєРё РёР· СѓРІРµРґРѕРјР»РµРЅРёР№ РЅРµ РґРѕР»Р¶РЅС‹ Р·Р°РїСѓСЃРєР°С‚СЊ
        # СѓР¶Рµ РЅР°С‡Р°С‚РѕРµ, Р·Р°РІРµСЂС€С‘РЅРЅРѕРµ РёР»Рё РѕС‚РјРµРЅС‘РЅРЅРѕРµ РЅР°Р·РЅР°С‡РµРЅРёРµ РїРѕРІС‚РѕСЂРЅРѕ.
        if a.get("status") != "assigned":
            await q.answer("Р­С‚Р° РїРѕРїС‹С‚РєР° СѓР¶Рµ РёСЃРїРѕР»СЊР·РѕРІР°РЅР° РёР»Рё РЅРµРґРѕСЃС‚СѓРїРЅР°.", show_alert=True)
            return
...
async def cb_help(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if data.startswith("help:notifications:open:"):
        ...
        # Р¦РµРЅС‚СЂ СѓРІРµРґРѕРјР»РµРЅРёР№ С‚РѕР»СЊРєРѕ РѕС‚РѕР±СЂР°Р¶Р°РµС‚ С‚РµСЃС‚РѕРІРѕРµ СЃРѕР±С‹С‚РёРµ. РџРµСЂРµС…РѕРґ РїРѕ
        # СЃС‚Р°СЂРѕР№ РєРЅРѕРїРєРµ РЅР°Р·РЅР°С‡РµРЅРёСЏ РјРѕРі РїРѕР·РІРѕР»РёС‚СЊ РїРѕРІС‚РѕСЂРЅРѕ РѕС‚РєСЂС‹С‚СЊ Р·Р°РІРµСЂС€С‘РЅРЅС‹Р№
        # С‚РµСЃС‚, РїРѕСЌС‚РѕРјСѓ РґР»СЏ РІСЃРµС… С‚РµСЃС‚РѕРІС‹С… СѓРІРµРґРѕРјР»РµРЅРёР№ РґРµР№СЃС‚РІРёРµ СЃРєСЂС‹РІР°РµРј.
        if (
            not _notification_is_test(item)
            and callback_data.startswith(("help:", "test:"))
...
def tv2_template_defaults(mode: str) -> dict:
    if mode == "learning":
        return {
            "passing_score": 70, "max_attempts": 1, "scoring_policy": "best",
...
def tv2_create_assignment(template_id: int, profile_id: int, assigned_by: int | None,
    ...
    # РљР°Р¶РґРѕРµ РЅР°Р·РЅР°С‡РµРЅРёРµ Р°РґРјРёРЅРёСЃС‚СЂР°С‚РѕСЂР° вЂ” РѕС‚РґРµР»СЊРЅР°СЏ РµРґРёРЅСЃС‚РІРµРЅРЅР°СЏ РїРѕРїС‹С‚РєР°.
    # РџР°СЂР°РјРµС‚СЂС‹ РїРѕРІС‚РѕСЂРЅРѕР№ РїРѕРїС‹С‚РєРё РѕСЃС‚Р°РІР»РµРЅС‹ РІ СЃРёРіРЅР°С‚СѓСЂРµ С‚РѕР»СЊРєРѕ РґР»СЏ СЃРѕРІРјРµСЃС‚РёРјРѕСЃС‚Рё
    # СЃРѕ СЃС‚Р°СЂС‹РјРё РґР°РЅРЅС‹РјРё, РЅРѕ СЃРѕС‚СЂСѓРґРЅРёРє РЅРµ РјРѕР¶РµС‚ СЃРѕР·РґР°С‚СЊ РµС‘ СЃР°Рј.
    attempt_no = 1
...
def tv2_can_retry(a: dict) -> bool:
    # РџРѕРІС‚РѕСЂРЅРѕРµ РїСЂРѕС…РѕР¶РґРµРЅРёРµ РІРѕР·РјРѕР¶РЅРѕ С‚РѕР»СЊРєРѕ С‡РµСЂРµР· РЅРѕРІРѕРµ РЅР°Р·РЅР°С‡РµРЅРёРµ
    # Р°РґРјРёРЅРёСЃС‚СЂР°С‚РѕСЂРѕРј, Р° РЅРµ РёР· РєР°Р±РёРЅРµС‚Р° СЃРѕС‚СЂСѓРґРЅРёРєР°.
    return False


def tv2_create_retry(aid: int, user_id: int | None) -> int | None:
    # РЎС‚Р°СЂС‹Рµ callback_data test:v2:retry РїСЂРѕРґРѕР»Р¶Р°СЋС‚ РїСЂРёС…РѕРґРёС‚СЊ РёР· Telegram,
    # РїРѕСЌС‚РѕРјСѓ С„СѓРЅРєС†РёСЏ РґРѕР»Р¶РЅР° СЏРІРЅРѕ РѕС‚РєР°Р·Р°С‚СЊ, РґР°Р¶Рµ РµСЃР»Рё callback Р±С‹Р» СЃРѕС…СЂР°РЅС‘РЅ
    # РґРѕ РѕР±РЅРѕРІР»РµРЅРёСЏ Р±РѕС‚Р°.
    return None
...
def tv2_template_text(tid: int) -> str:
    ...
    return (
        ...
        "РџРѕРїС‹С‚РєР° СЃРѕС‚СЂСѓРґРЅРёРєР°: <b>1</b>\n"
...
def tv2_kb_settings(tid: int):
    ...
    return InlineKeyboardMarkup([
        ...
        [InlineKeyboardButton("РџРѕРїС‹С‚РєР°: 1 В· РїРѕРІС‚РѕСЂРЅРѕ С‚РѕР»СЊРєРѕ РїРѕ РЅР°Р·РЅР°С‡РµРЅРёСЋ Р°РґРјРёРЅРёСЃС‚СЂР°С‚РѕСЂР°", callback_data="noop")],
...
def tv2_kb_my_open(a: dict):
    ...
    # РџРѕРІС‚РѕСЂРЅР°СЏ РєРЅРѕРїРєР° РЅР°РјРµСЂРµРЅРЅРѕ РѕС‚СЃСѓС‚СЃС‚РІСѓРµС‚: РЅРѕРІСѓСЋ РїРѕРїС‹С‚РєСѓ СЃРѕР·РґР°С‘С‚ С‚РѕР»СЊРєРѕ
    # Р°РґРјРёРЅРёСЃС‚СЂР°С‚РѕСЂ РЅРѕРІС‹Рј РЅР°Р·РЅР°С‡РµРЅРёРµРј.
...
async def cb_help(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if data.startswith("help:testv2:set:"):
        ...
        choices={
            ...
            "attempts":[("РўРѕР»СЊРєРѕ 1 РїРѕРїС‹С‚РєР°","1")],
...
async def on_text(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if state.startswith("custom_"):
        ...
        col={"passing":"passing_score","time":"default_time_limit_sec","attempts":"max_attempts"}[setting]
        if setting == "attempts":
            value = 1
...
def db_init():
    ...
    # Р•РґРёРЅРѕРµ РїСЂР°РІРёР»Рѕ РґР»СЏ РІСЃРµС… С‚РёРїРѕРІ С‚РµСЃС‚РѕРІ, РІРєР»СЋС‡Р°СЏ СЃС‚Р°СЂС‹Рµ С€Р°Р±Р»РѕРЅС‹: РѕРґРЅР°
    # РїРѕРїС‹С‚РєР°. РџРѕРІС‚РѕСЂ РїРѕСЏРІР»СЏРµС‚СЃСЏ С‚РѕР»СЊРєРѕ РїРѕСЃР»Рµ РЅРѕРІРѕРіРѕ РЅР°Р·РЅР°С‡РµРЅРёСЏ Р°РґРјРёРЅРёСЃС‚СЂР°С‚РѕСЂРѕРј.
    cur.execute("UPDATE test_templates SET max_attempts=1 WHERE COALESCE(max_attempts, 1) <> 1")
    con.commit()
    con.close()
...
def tv2_result_text(aid: int) -> str:
    ...
    lines.append("РџРѕРїС‹С‚РєР° СЃРѕС‚СЂСѓРґРЅРёРєР°: <b>1</b>")
...
def tv2_kb_settings(tid: int):
    ...
    return InlineKeyboardMarkup([
        ...
        [InlineKeyboardButton(
            "РџРѕРїС‹С‚РєР°: 1 В· РїРѕРІС‚РѕСЂРЅРѕ С‚РѕР»СЊРєРѕ РїРѕ РЅР°Р·РЅР°С‡РµРЅРёСЋ Р°РґРјРёРЅРёСЃС‚СЂР°С‚РѕСЂР°",
            callback_data="noop",
        )],
        [InlineKeyboardButton(
...
async def cb_test(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if action not in ("start", "continue", "retry") and assignment.get("status") not in ("in_progress", "saved"):
        try:
            await update.callback_query.answer("Р­С‚Р° РїРѕРїС‹С‚РєР° СѓР¶Рµ РёСЃРїРѕР»СЊР·РѕРІР°РЅР° РёР»Рё РЅРµРґРѕСЃС‚СѓРїРЅР°.", show_alert=True)
        except Exception:
            pass
        return
...
def tv2_publish_template(tid: int, user_id: int | None = None) -> int:
    # Р”Р°Р¶Рµ РѕРїСѓР±Р»РёРєРѕРІР°РЅРЅР°СЏ СЃС‚Р°СЂР°СЏ РІРµСЂСЃРёСЏ РЅРµ РґРѕР»Р¶РЅР° СѓРЅР°СЃР»РµРґРѕРІР°С‚СЊ Р»РёРјРёС‚ РїРѕРІС‚РѕСЂРѕРІ.
    with tv2_connect() as con:
        con.execute(
