...
async def start_cmd(update: Update, context: ContextTypes.DEFAULT_TYPE):
    """Начало игры (только для групп и только админы)."""
    chat = update.effective_chat
...
👥 *Как играть:*
1. Администратор запускает игру командой /start
...
🎯 *Команды:*
/start - начать игру (только админы)
/join - присоединиться к игре
/leave - выйти из игры
...
🎮 *Основные команды:*
/start - начать новую игру (админы)
/join - присоединиться к игре
/leave - выйти из игры
/hint - получить подсказку (1 за игру)
